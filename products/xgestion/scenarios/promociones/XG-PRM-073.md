---
{"id":"XG-PRM-073","title":"Aplicar una oferta configurada para todas las formas de pago","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-condiciones","cobros","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/medios-pago.robot","seed":"catalogo-comercial-v1"}
---
...
Aplicar una oferta configurada para todas las formas de pago durante una venta, con importes y efectos observables por el vendedor o cajero.
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-073 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-073-V0-A` | $1.000,00 | unidad | 980001 / 980001 / 980001 | QA-SEED |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-073-V0` | Producto `QA-PRM-073-V0-A` | 10 % sobre el importe | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 3 | Cargar 1 u de `QA-PRM-073-V0-A` por código. | `QA-PRM-073-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. |
| 4 | Cargar 1 u de `QA-PRM-073-V0-A` por código. | `QA-PRM-073-V0-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 5 | Abrir cobro en `QA-PRM-EFECTIVO`, ingresar $1.800,00 y cancelar antes de confirmar. | `QA-PRM-073-V0-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 6 | Retomar el cobro en `QA-PRM-EFECTIVO`, ingresar $1.800,00 y confirmar una sola vez. | `QA-PRM-073-V0-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. Una venta y un cobro en `QA-PRM-EFECTIVO`; vuelto cero. Stock: `QA-PRM-073-V0-A` −2 u. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-073-V1-A` | $1.000,00 | unidad | 980001 / 980001 / 980001 | QA-SEED |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-073-V1` | Producto `QA-PRM-073-V1-A` | 10 % sobre el importe | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 3 | Cargar 1 u de `QA-PRM-073-V1-A` por código. | `QA-PRM-073-V1-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. |
| 4 | Cargar 1 u de `QA-PRM-073-V1-A` por código. | `QA-PRM-073-V1-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 5 | Abrir cobro en `QA-PRM-TRANSFERENCIA`, ingresar $1.800,00 y cancelar antes de confirmar. | `QA-PRM-073-V1-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 6 | Retomar el cobro en `QA-PRM-TRANSFERENCIA`, ingresar $1.800,00 y confirmar una sola vez. | `QA-PRM-073-V1-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. Una venta y un cobro en `QA-PRM-TRANSFERENCIA`; vuelto cero. Stock: `QA-PRM-073-V1-A` −2 u. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-073-V2-A` | $1.000,00 | unidad | 980001 / 980001 / 980001 | QA-SEED |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-073-V2` | Producto `QA-PRM-073-V2-A` | 10 % sobre el importe | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 3 | Cargar 1 u de `QA-PRM-073-V2-A` por código. | `QA-PRM-073-V2-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. |
| 4 | Cargar 1 u de `QA-PRM-073-V2-A` por código. | `QA-PRM-073-V2-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 5 | Abrir cobro en `QA-PRM-TARJETA`, ingresar $1.800,00 y cancelar antes de confirmar. | `QA-PRM-073-V2-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 6 | Retomar el cobro en `QA-PRM-TARJETA`, ingresar $1.800,00 y confirmar una sola vez. | `QA-PRM-073-V2-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. Una venta y un cobro en `QA-PRM-TARJETA`; vuelto cero. Stock: `QA-PRM-073-V2-A` −2 u. |
...
- Producto nuevo de $1.000, 10% con formas de pago Todos. Efectivo, transferencia y tarjeta registrados como medios manuales internos QA, sin terminal, proveedor ni red y sin recargos/descuentos propios. El paquete actual de efectivo no habilita automáticamente estos perfiles.
...
| --- | --- |
| En corridas independientes elegir efectivo, transferencia o tarjeta y cargar una unidad. | Neto $900 en las tres; Todos no se confunde con un medio concreto. |
| Agregar otra unidad en cada corrida. | Bruto $2.000, oferta $200, neto $1.800. |
| Abrir y cancelar el cobro del medio elegido. | Se conservan venta e importe, sin pago confirmado. |
| Retomar y confirmar por $1.800. | Un único registro de pago en el medio de esa corrida; sin llamada a servicios externos. |

## Dependencias para automatizar

Preparar/calibrar cobro simple de los medios manuales offline. La verificación de persistencia deberá distinguir destino e identidad del pago; no asumir que todos generan el mismo asiento de caja que efectivo.
