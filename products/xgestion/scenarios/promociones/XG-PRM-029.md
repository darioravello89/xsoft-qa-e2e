---
{"id":"XG-PRM-029","title":"Aplicar el 10 % desde dos unidades por marca","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-alcances","ofertas-marca","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/marca.robot","seed":"catalogo-comercial-v1"}
---
...
El vendedor comprueba 10 % desde 2 unidades por marca, distingue los productos incluidos de los ajenos y conserva el importe correcto al corregir cantidades y retomar un cobro.
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-029 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-029-A` | $1.000,00 | unidad | 983900 / 983900 / 980001 | QA-PRM-029-MARCA |
| B | `QA-PRM-029-B` | $1.000,00 | unidad | 983901 / 983901 / 980001 | QA-PRM-029-MARCA |
| E | `QA-PRM-029-E` | $1.000,00 | unidad | 983900 / 983900 / 980001 | QA-PRM-029-OTRA-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-029` | Marca `QA-PRM-029-MARCA` | Desde 2: 10 % sobre toda la cantidad | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-029-E` por código. | `QA-PRM-029-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-029-A` por código. | `QA-PRM-029-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-029-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Seleccionar `QA-PRM-029-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-029-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-029-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$2.800,00**. |
| 5 | Seleccionar `QA-PRM-029-A`, abrir Ctrl+E, dejar 3 u y guardar. | `QA-PRM-029-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-029-A` × 3 u: precio $1.000,00; automático $300,00; manual $0,00; neto $2.700,00; lista aplicada: precio normal | Total **$3.700,00**. |
| 6 | Seleccionar `QA-PRM-029-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-029-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-029-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 7 | Cargar 1 u de `QA-PRM-029-B` por código. | `QA-PRM-029-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-029-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-029-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 8 | Seleccionar `QA-PRM-029-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-029-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-029-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal<br>`QA-PRM-029-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.800,00**. |
| 9 | Abrir cobro en efectivo del perfil QA, ingresar $3.800,00 y cancelar antes de confirmar. | `QA-PRM-029-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-029-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal<br>`QA-PRM-029-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.800,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 10 | Retomar el cobro en efectivo del perfil QA, ingresar $3.800,00 y confirmar una sola vez. | `QA-PRM-029-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-029-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal<br>`QA-PRM-029-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.800,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-029-E` −1 u; `QA-PRM-029-A` −2 u; `QA-PRM-029-B` −1 u. |
...
- **Fixture nuevo pendiente de preparar:** `xg-prm-029-alcance-v1`. A = `QA-PEND-PRM-029-A` y B = `QA-PEND-PRM-029-B` son identificadores propuestos, todavía ausentes del seed; deben tener una clasificación exclusiva para esta oferta. E = `QA-SEED-NORMAL` puede reutilizarse del catálogo base y debe quedar fuera del alcance.
...
| 3 | Cargar A (`QA-PEND-PRM-029-A`), cantidad 1. | A: bruto $1.000,00, descuento $0,00, neto $1.000,00. E continúa en $1.000,00; total de venta $2.000,00. |
...
| 7 | Cargar B (`QA-PEND-PRM-029-B`), cantidad 1, sin modificar A. | A y B se calculan por separado: cada uno queda en $1.000,00; E sigue en $1.000,00; total $3.000,00. Aunque A+B suman dos unidades del alcance, ninguno alcanza por separado el mínimo; no hay beneficio agrupado. |
