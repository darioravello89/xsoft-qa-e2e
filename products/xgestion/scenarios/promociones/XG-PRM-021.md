---
{"id":"XG-PRM-021","title":"Aplicar la segunda unidad al 50 % por subfamilia","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-alcances","ofertas-subfamilia","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/subfamilia.robot","seed":"catalogo-comercial-v1"}
---
...
El vendedor comprueba segunda unidad al 50 % por subfamilia, distingue los productos incluidos de los ajenos y conserva el importe correcto al corregir cantidades y retomar un cobro.
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-021 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-021-A` | $1.000,00 | unidad | 983100 / 983100 / 980001 | QA-SEED |
| B | `QA-PRM-021-B` | $1.000,00 | unidad | 983100 / 983100 / 980001 | QA-SEED |
| E | `QA-PRM-021-E` | $1.000,00 | unidad | 983100 / 983109 / 980001 | QA-SEED |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-021` | Subfamilia `983100` | 50 % en una unidad de cada grupo completo de 2 | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-021-E` por código. | `QA-PRM-021-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-021-A` por código. | `QA-PRM-021-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-021-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Seleccionar `QA-PRM-021-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-021-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-021-A` × 2 u: precio $1.000,00; automático $500,00; manual $0,00; neto $1.500,00; lista aplicada: precio normal | Total **$2.500,00**. |
| 5 | Seleccionar `QA-PRM-021-A`, abrir Ctrl+E, dejar 3 u y guardar. | `QA-PRM-021-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-021-A` × 3 u: precio $1.000,00; automático $500,00; manual $0,00; neto $2.500,00; lista aplicada: precio normal | Total **$3.500,00**. |
| 6 | Seleccionar `QA-PRM-021-A`, abrir Ctrl+E, dejar 4 u y guardar. | `QA-PRM-021-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-021-A` × 4 u: precio $1.000,00; automático $1.000,00; manual $0,00; neto $3.000,00; lista aplicada: precio normal | Total **$4.000,00**. |
| 7 | Seleccionar `QA-PRM-021-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-021-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-021-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 8 | Cargar 1 u de `QA-PRM-021-B` por código. | `QA-PRM-021-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-021-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-021-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 9 | Seleccionar `QA-PRM-021-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-021-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-021-A` × 2 u: precio $1.000,00; automático $500,00; manual $0,00; neto $1.500,00; lista aplicada: precio normal<br>`QA-PRM-021-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.500,00**. |
| 10 | Abrir cobro en efectivo del perfil QA, ingresar $3.500,00 y cancelar antes de confirmar. | `QA-PRM-021-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-021-A` × 2 u: precio $1.000,00; automático $500,00; manual $0,00; neto $1.500,00; lista aplicada: precio normal<br>`QA-PRM-021-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.500,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 11 | Retomar el cobro en efectivo del perfil QA, ingresar $3.500,00 y confirmar una sola vez. | `QA-PRM-021-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-021-A` × 2 u: precio $1.000,00; automático $500,00; manual $0,00; neto $1.500,00; lista aplicada: precio normal<br>`QA-PRM-021-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.500,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-021-E` −1 u; `QA-PRM-021-A` −2 u; `QA-PRM-021-B` −1 u. |
...
- **Fixture nuevo pendiente de preparar:** `xg-prm-021-alcance-v1`. A = `QA-PEND-PRM-021-A` y B = `QA-PEND-PRM-021-B` son identificadores propuestos, todavía ausentes del seed; deben tener una clasificación exclusiva para esta oferta. E = `QA-SEED-NORMAL` puede reutilizarse del catálogo base y debe quedar fuera del alcance.
...
| 3 | Cargar A (`QA-PEND-PRM-021-A`), cantidad 1. | A: bruto $1.000,00, descuento $0,00, neto $1.000,00. E continúa en $1.000,00; total de venta $2.000,00. |
...
| 8 | Cargar B (`QA-PEND-PRM-021-B`), cantidad 1, sin modificar A. | A y B se calculan por separado: cada uno queda en $1.000,00; E sigue en $1.000,00; total $3.000,00. Aunque A+B suman dos unidades del alcance, ninguno alcanza por separado el mínimo; no hay beneficio agrupado. |
