...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-051 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-051-V0-A` | $1.000,00 | unidad | 986100 / 986100 / 986100 | QA-PRM-051-V0-MARCA-A |
| B | `QA-PRM-051-V0-B` | $1.000,00 | unidad | 986100 / 986100 / 986100 | QA-PRM-051-V0-MARCA-B |
| E | `QA-PRM-051-V0-E` | $1.000,00 | unidad | 986100 / 986109 / 986100 | QA-PRM-051-V0-MARCA-A |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-051-V0` | Subfamilia `986100` | Desde 2: $150,00 de descuento por unidad | ON | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-051-V0-A` por código. | `QA-PRM-051-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-051-V0-E` por código. | `QA-PRM-051-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-051-V0-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Seleccionar `QA-PRM-051-V0-E`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-051-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 5 | Cargar 1 u de `QA-PRM-051-V0-B` por código. | `QA-PRM-051-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-051-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.700,00**. |
| 6 | Seleccionar `QA-PRM-051-V0-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-051-V0-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal<br>`QA-PRM-051-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$2.550,00**. |
| 7 | Seleccionar `QA-PRM-051-V0-B`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-051-V0-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal | Total **$1.700,00**. |
| 8 | Seleccionar `QA-PRM-051-V0-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-051-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
...
| 11 | Cargar 1 u de `QA-PRM-051-V0-A` por código. | `QA-PRM-051-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 12 | Cargar 1 u de `QA-PRM-051-V0-B` por código. | `QA-PRM-051-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-051-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.700,00**. |
| 13 | Abrir cobro en efectivo del perfil QA, ingresar $1.700,00 y cancelar antes de confirmar. | `QA-PRM-051-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-051-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.700,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 14 | Retomar el cobro en efectivo del perfil QA, ingresar $1.700,00 y confirmar una sola vez. | `QA-PRM-051-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-051-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.700,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-051-V0-A` −1 u; `QA-PRM-051-V0-B` −1 u. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-051-V1-A` | $1.000,00 | unidad | 986110 / 986110 / 986110 | QA-PRM-051-V1-MARCA-A |
| B | `QA-PRM-051-V1-B` | $1.000,00 | unidad | 986110 / 986110 / 986110 | QA-PRM-051-V1-MARCA-B |
| E | `QA-PRM-051-V1-E` | $1.000,00 | unidad | 986110 / 986119 / 986110 | QA-PRM-051-V1-MARCA-A |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-051-V1` | Subfamilia `986110` | Desde 2: $150,00 de descuento por unidad | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| ---: | --- | --- | --- |
| 1 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 2 | Cargar 1 u de `QA-PRM-051-V1-A` por código. | `QA-PRM-051-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-051-V1-B` por código. | `QA-PRM-051-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-051-V1-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Seleccionar `QA-PRM-051-V1-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-051-V1-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal<br>`QA-PRM-051-V1-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.700,00**. |
...
- **NUEVO PENDIENTE DE PREPARAR:** perfil QA-XG-PRM-051, productos A y B exclusivos de una misma subfamilia, un producto Ajeno de otra subfamilia y la oferta indicada. Son nombres funcionales propuestos, sin IDs asignados ni filas disponibles en el seed actual. Preparar dos copias del perfil: agrupación activada y desactivada, con idénticos datos y una sola regla comercial.
