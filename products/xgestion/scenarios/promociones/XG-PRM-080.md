---
{"id":"XG-PRM-080","title":"Cobrar precio final USD 50 por producto","product":"xgestion","module":"promociones","priority":"P0","tags":["xgestion","regression","promociones","promociones-alcances","ofertas-producto","ofertas-usd","p0","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/usd.robot","seed":"catalogo-comercial-v1"}
---

# XG-PRM-080 — Precio final USD 50 por producto
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-080 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-080-V0-A` | USD 100,00 | unidad | 989000 / 989000 / 989001 | QA-PRM-080-V0-MARCA-1 |
| E | `QA-PRM-080-V0-E` | USD 100,00 | unidad | 989000 / 989009 / 989001 | QA-PRM-080-V0-MARCA-1 |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-080-V0` | Producto `QA-PRM-080-V0-A` | Desde 1: precio final USD 50,00 por unidad | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-080-V0-A` por código. | `QA-PRM-080-V0-A` × 1 u: precio $150.000,00; automático $75.000,00; manual $0,00; neto $75.000,00; original USD: precio USD 100,00, descuento USD 50,00; lista aplicada: precio normal | Total **$75.000,00**. |
| 3 | Seleccionar `QA-PRM-080-V0-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-080-V0-A` × 2 u: precio $150.000,00; automático $150.000,00; manual $0,00; neto $150.000,00; original USD: precio USD 100,00, descuento USD 100,00; lista aplicada: precio normal | Total **$150.000,00**. |
| 4 | Seleccionar `QA-PRM-080-V0-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-080-V0-A` × 1 u: precio $150.000,00; automático $75.000,00; manual $0,00; neto $75.000,00; original USD: precio USD 100,00, descuento USD 50,00; lista aplicada: precio normal | Total **$75.000,00**. |
| 5 | Cargar 1 u de `QA-PRM-080-V0-E` por código. | `QA-PRM-080-V0-A` × 1 u: precio $150.000,00; automático $75.000,00; manual $0,00; neto $75.000,00; original USD: precio USD 100,00, descuento USD 50,00; lista aplicada: precio normal<br>`QA-PRM-080-V0-E` × 1 u: precio $150.000,00; automático $0,00; manual $0,00; neto $150.000,00; original USD: precio USD 100,00, descuento USD 0,00; lista aplicada: precio normal | Total **$225.000,00**. |
| 6 | Seleccionar `QA-PRM-080-V0-E`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-080-V0-A` × 1 u: precio $150.000,00; automático $75.000,00; manual $0,00; neto $75.000,00; original USD: precio USD 100,00, descuento USD 50,00; lista aplicada: precio normal | Total **$75.000,00**. |
| 7 | Abrir cobro en efectivo del perfil QA, ingresar $75.000,00 y cancelar antes de confirmar. | `QA-PRM-080-V0-A` × 1 u: precio $150.000,00; automático $75.000,00; manual $0,00; neto $75.000,00; original USD: precio USD 100,00, descuento USD 50,00; lista aplicada: precio normal | Total **$75.000,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 8 | Retomar el cobro en efectivo del perfil QA, ingresar $75.000,00 y confirmar una sola vez. | `QA-PRM-080-V0-A` × 1 u: precio $150.000,00; automático $75.000,00; manual $0,00; neto $75.000,00; original USD: precio USD 100,00, descuento USD 50,00; lista aplicada: precio normal | Total **$75.000,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-080-V0-A` −1 u. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-080-V1-A` | USD 100,00 | unidad | 989010 / 989010 / 989011 | QA-PRM-080-V1-MARCA-1 |
| E | `QA-PRM-080-V1-E` | USD 100,00 | unidad | 989010 / 989019 / 989011 | QA-PRM-080-V1-MARCA-1 |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-080-V1` | Producto `QA-PRM-080-V1-A` | Desde 2: precio final USD 50,00 por unidad | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| ---: | --- | --- | --- |
| 1 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 2 | Cargar 1 u de `QA-PRM-080-V1-A` por código. | `QA-PRM-080-V1-A` × 1 u: precio $150.000,00; automático $0,00; manual $0,00; neto $150.000,00; original USD: precio USD 100,00, descuento USD 0,00; lista aplicada: precio normal | Total **$150.000,00**. |
| 3 | Seleccionar `QA-PRM-080-V1-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-080-V1-A` × 2 u: precio $150.000,00; automático $150.000,00; manual $0,00; neto $150.000,00; original USD: precio USD 100,00, descuento USD 100,00; lista aplicada: precio normal | Total **$150.000,00**. |
| 4 | Seleccionar `QA-PRM-080-V1-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-080-V1-A` × 1 u: precio $150.000,00; automático $0,00; manual $0,00; neto $150.000,00; original USD: precio USD 100,00, descuento USD 0,00; lista aplicada: precio normal | Total **$150.000,00**. |
| 5 | Cargar 1 u de `QA-PRM-080-V1-E` por código. | `QA-PRM-080-V1-A` × 1 u: precio $150.000,00; automático $0,00; manual $0,00; neto $150.000,00; original USD: precio USD 100,00, descuento USD 0,00; lista aplicada: precio normal<br>`QA-PRM-080-V1-E` × 1 u: precio $150.000,00; automático $0,00; manual $0,00; neto $150.000,00; original USD: precio USD 100,00, descuento USD 0,00; lista aplicada: precio normal | Total **$300.000,00**. |
| 6 | Seleccionar `QA-PRM-080-V1-E`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-080-V1-A` × 1 u: precio $150.000,00; automático $0,00; manual $0,00; neto $150.000,00; original USD: precio USD 100,00, descuento USD 0,00; lista aplicada: precio normal | Total **$150.000,00**. |
| 7 | Seleccionar `QA-PRM-080-V1-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-080-V1-A` × 2 u: precio $150.000,00; automático $150.000,00; manual $0,00; neto $150.000,00; original USD: precio USD 100,00, descuento USD 100,00; lista aplicada: precio normal | Total **$150.000,00**. |
| 8 | Abrir cobro en efectivo del perfil QA, ingresar $150.000,00 y cancelar antes de confirmar. | `QA-PRM-080-V1-A` × 2 u: precio $150.000,00; automático $150.000,00; manual $0,00; neto $150.000,00; original USD: precio USD 100,00, descuento USD 100,00; lista aplicada: precio normal | Total **$150.000,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 9 | Retomar el cobro en efectivo del perfil QA, ingresar $150.000,00 y confirmar una sola vez. | `QA-PRM-080-V1-A` × 2 u: precio $150.000,00; automático $150.000,00; manual $0,00; neto $150.000,00; original USD: precio USD 100,00, descuento USD 100,00; lista aplicada: precio normal | Total **$150.000,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-080-V1-A` −2 u. |
