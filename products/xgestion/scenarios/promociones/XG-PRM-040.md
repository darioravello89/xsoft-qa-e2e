---
{"id":"XG-PRM-040","title":"Agrupar por familia: descuento de $150 por unidad entre productos","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-agrupadas","ofertas-familia","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/agrupadas.robot","seed":"catalogo-comercial-v1"}
---
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-040 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-040-V0-A` | $1.000,00 | unidad | 985000 / 985001 / 985000 | QA-PRM-040-V0-MARCA |
| B | `QA-PRM-040-V0-B` | $1.000,00 | unidad | 985000 / 985002 / 985000 | QA-PRM-040-V0-MARCA |
| E | `QA-PRM-040-V0-E` | $1.000,00 | unidad | 985009 / 985009 / 985000 | QA-PRM-040-V0-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-040-V0` | Familia `985000` | $150,00 de descuento por unidad | ON | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-040-V0-A` por código. | `QA-PRM-040-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$850,00**. |
| 3 | Cargar 1 u de `QA-PRM-040-V0-E` por código. | `QA-PRM-040-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-040-V0-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.850,00**. |
| 4 | Seleccionar `QA-PRM-040-V0-E`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-040-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$850,00**. |
| 5 | Cargar 1 u de `QA-PRM-040-V0-B` por código. | `QA-PRM-040-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-040-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.700,00**. |
| 6 | Seleccionar `QA-PRM-040-V0-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-040-V0-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal<br>`QA-PRM-040-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$2.550,00**. |
| 7 | Seleccionar `QA-PRM-040-V0-B`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-040-V0-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal | Total **$1.700,00**. |
| 8 | Seleccionar `QA-PRM-040-V0-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-040-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$850,00**. |
...
| 11 | Cargar 1 u de `QA-PRM-040-V0-A` por código. | `QA-PRM-040-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$850,00**. |
| 12 | Cargar 1 u de `QA-PRM-040-V0-B` por código. | `QA-PRM-040-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-040-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.700,00**. |
| 13 | Abrir cobro en efectivo del perfil QA, ingresar $1.700,00 y cancelar antes de confirmar. | `QA-PRM-040-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-040-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.700,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 14 | Retomar el cobro en efectivo del perfil QA, ingresar $1.700,00 y confirmar una sola vez. | `QA-PRM-040-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-040-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.700,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-040-V0-A` −1 u; `QA-PRM-040-V0-B` −1 u. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-040-V1-A` | $1.000,00 | unidad | 985010 / 985011 / 985010 | QA-PRM-040-V1-MARCA |
| B | `QA-PRM-040-V1-B` | $1.000,00 | unidad | 985010 / 985012 / 985010 | QA-PRM-040-V1-MARCA |
| E | `QA-PRM-040-V1-E` | $1.000,00 | unidad | 985019 / 985019 / 985010 | QA-PRM-040-V1-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-040-V1` | Familia `985010` | $150,00 de descuento por unidad | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| ---: | --- | --- | --- |
| 1 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 2 | Cargar 1 u de `QA-PRM-040-V1-A` por código. | `QA-PRM-040-V1-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$850,00**. |
| 3 | Cargar 1 u de `QA-PRM-040-V1-B` por código. | `QA-PRM-040-V1-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-040-V1-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.700,00**. |
| 4 | Seleccionar `QA-PRM-040-V1-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-040-V1-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal<br>`QA-PRM-040-V1-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$2.550,00**. |
...
- **NUEVO PENDIENTE DE PREPARAR:** perfil QA-XG-PRM-040, productos A y B exclusivos de una misma familia, un producto Ajeno de otra familia y la oferta indicada. Son nombres funcionales propuestos, sin IDs asignados ni filas disponibles en el seed actual. Preparar dos copias del perfil: agrupación activada y desactivada, con idénticos datos y una sola regla comercial.
