---
{"id":"XG-PRM-048","title":"Agrupar por subfamilia: 3x2 entre productos","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-agrupadas","ofertas-subfamilia","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/agrupadas.robot","seed":"catalogo-comercial-v1"}
---
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-048 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-048-V0-A` | $1.000,00 | unidad | 985800 / 985800 / 985800 | QA-PRM-048-V0-MARCA-A |
| B | `QA-PRM-048-V0-B` | $1.000,00 | unidad | 985800 / 985800 / 985800 | QA-PRM-048-V0-MARCA-B |
| C | `QA-PRM-048-V0-C` | $1.000,00 | unidad | 985800 / 985800 / 985800 | QA-PRM-048-V0-MARCA-C |
| E | `QA-PRM-048-V0-E` | $1.000,00 | unidad | 985800 / 985809 / 985800 | QA-PRM-048-V0-MARCA-A |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-048-V0` | Subfamilia `985800` | Llevar 3 y pagar 2 | ON | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-048-V0-A` por código. | `QA-PRM-048-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-048-V0-E` por código. | `QA-PRM-048-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-048-V0-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Cargar 1 u de `QA-PRM-048-V0-B` por código. | `QA-PRM-048-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-048-V0-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-048-V0-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 5 | Seleccionar `QA-PRM-048-V0-E`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-048-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-048-V0-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 6 | Cargar 1 u de `QA-PRM-048-V0-C` por código. | `QA-PRM-048-V0-A` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-048-V0-B` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-048-V0-C` × 1 u: precio $1.000,00; automático $333,34; manual $0,00; neto $666,66; lista aplicada: precio normal | Total **$2.000,00**. |
| 7 | Seleccionar `QA-PRM-048-V0-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-048-V0-A` × 2 u: precio $1.000,00; automático $500,00; manual $0,00; neto $1.500,00; lista aplicada: precio normal<br>`QA-PRM-048-V0-B` × 1 u: precio $1.000,00; automático $250,00; manual $0,00; neto $750,00; lista aplicada: precio normal<br>`QA-PRM-048-V0-C` × 1 u: precio $1.000,00; automático $250,00; manual $0,00; neto $750,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 8 | Seleccionar `QA-PRM-048-V0-C`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-048-V0-A` × 2 u: precio $1.000,00; automático $666,67; manual $0,00; neto $1.333,33; lista aplicada: precio normal<br>`QA-PRM-048-V0-B` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal | Total **$2.000,00**. |
| 9 | Seleccionar `QA-PRM-048-V0-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-048-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-048-V0-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
...
| 12 | Cargar 1 u de `QA-PRM-048-V0-A` por código. | `QA-PRM-048-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 13 | Cargar 1 u de `QA-PRM-048-V0-B` por código. | `QA-PRM-048-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-048-V0-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 14 | Cargar 1 u de `QA-PRM-048-V0-C` por código. | `QA-PRM-048-V0-A` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-048-V0-B` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-048-V0-C` × 1 u: precio $1.000,00; automático $333,34; manual $0,00; neto $666,66; lista aplicada: precio normal | Total **$2.000,00**. |
| 15 | Abrir cobro en efectivo del perfil QA, ingresar $2.000,00 y cancelar antes de confirmar. | `QA-PRM-048-V0-A` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-048-V0-B` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-048-V0-C` × 1 u: precio $1.000,00; automático $333,34; manual $0,00; neto $666,66; lista aplicada: precio normal | Total **$2.000,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 16 | Retomar el cobro en efectivo del perfil QA, ingresar $2.000,00 y confirmar una sola vez. | `QA-PRM-048-V0-A` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-048-V0-B` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-048-V0-C` × 1 u: precio $1.000,00; automático $333,34; manual $0,00; neto $666,66; lista aplicada: precio normal | Total **$2.000,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-048-V0-A` −1 u; `QA-PRM-048-V0-B` −1 u; `QA-PRM-048-V0-C` −1 u. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-048-V1-A` | $1.000,00 | unidad | 985810 / 985810 / 985810 | QA-PRM-048-V1-MARCA-A |
| B | `QA-PRM-048-V1-B` | $1.000,00 | unidad | 985810 / 985810 / 985810 | QA-PRM-048-V1-MARCA-B |
| C | `QA-PRM-048-V1-C` | $1.000,00 | unidad | 985810 / 985810 / 985810 | QA-PRM-048-V1-MARCA-C |
| E | `QA-PRM-048-V1-E` | $1.000,00 | unidad | 985810 / 985819 / 985810 | QA-PRM-048-V1-MARCA-A |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-048-V1` | Subfamilia `985810` | Llevar 3 y pagar 2 | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| ---: | --- | --- | --- |
| 1 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 2 | Cargar 1 u de `QA-PRM-048-V1-A` por código. | `QA-PRM-048-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-048-V1-B` por código. | `QA-PRM-048-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-048-V1-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Cargar 1 u de `QA-PRM-048-V1-C` por código. | `QA-PRM-048-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-048-V1-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-048-V1-C` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 5 | Seleccionar `QA-PRM-048-V1-A`, abrir Ctrl+E, dejar 3 u y guardar. | `QA-PRM-048-V1-A` × 3 u: precio $1.000,00; automático $1.000,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal<br>`QA-PRM-048-V1-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-048-V1-C` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$4.000,00**. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-048-V2-A` | $1.000,00 | unidad | 985820 / 985820 / 985820 | QA-PRM-048-V2-MARCA-A |
| B | `QA-PRM-048-V2-B` | $2.000,00 | unidad | 985820 / 985820 / 985820 | QA-PRM-048-V2-MARCA-B |
| C | `QA-PRM-048-V2-C` | $3.000,00 | unidad | 985820 / 985820 / 985820 | QA-PRM-048-V2-MARCA-C |
| E | `QA-PRM-048-V2-E` | $1.000,00 | unidad | 985820 / 985829 / 985820 | QA-PRM-048-V2-MARCA-A |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-048-V2` | Subfamilia `985820` | Llevar 3 y pagar 2 | ON | Activa; hoy -365 días a hoy +365 días | Todos |
...
| ---: | --- | --- | --- |
| 1 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 2 | Cargar 1 u de `QA-PRM-048-V2-A` por código. | `QA-PRM-048-V2-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-048-V2-B` por código. | `QA-PRM-048-V2-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-048-V2-B` × 1 u: precio $2.000,00; automático $0,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 4 | Cargar 1 u de `QA-PRM-048-V2-C` por código. | `QA-PRM-048-V2-A` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-048-V2-B` × 1 u: precio $2.000,00; automático $666,67; manual $0,00; neto $1.333,33; lista aplicada: precio normal<br>`QA-PRM-048-V2-C` × 1 u: precio $3.000,00; automático $1.000,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$4.000,00**. |
| 5 | Seleccionar `QA-PRM-048-V2-C`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-048-V2-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-048-V2-B` × 1 u: precio $2.000,00; automático $0,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 6 | Cargar 1 u de `QA-PRM-048-V2-C` por código. | `QA-PRM-048-V2-A` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-048-V2-B` × 1 u: precio $2.000,00; automático $666,67; manual $0,00; neto $1.333,33; lista aplicada: precio normal<br>`QA-PRM-048-V2-C` × 1 u: precio $3.000,00; automático $1.000,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$4.000,00**. |
...
- **NUEVO PENDIENTE DE PREPARAR:** perfil QA-XG-PRM-048, productos A y B y C exclusivos de una misma subfamilia, un producto Ajeno de otra subfamilia y la oferta indicada. Son nombres funcionales propuestos, sin IDs asignados ni filas disponibles en el seed actual. Preparar dos copias del perfil: agrupación activada y desactivada, con idénticos datos y una sola regla comercial.
- A y B pertenecen a la misma subfamilia. Ajeno debe pertenecer a otra subfamilia de la misma familia, para demostrar que la coincidencia de familia no basta. C también pertenece al grupo elegido.
