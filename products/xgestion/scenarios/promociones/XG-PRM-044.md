...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-044 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-044-V0-A` | $1.000,00 | unidad | 985400 / 985401 / 985400 | QA-PRM-044-V0-MARCA |
| B | `QA-PRM-044-V0-B` | $1.000,00 | unidad | 985400 / 985402 / 985400 | QA-PRM-044-V0-MARCA |
| E | `QA-PRM-044-V0-E` | $1.000,00 | unidad | 985409 / 985409 / 985400 | QA-PRM-044-V0-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-044-V0` | Familia `985400` | Desde 2: $150,00 de descuento por unidad | ON | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-044-V0-A` por código. | `QA-PRM-044-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-044-V0-E` por código. | `QA-PRM-044-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-044-V0-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Seleccionar `QA-PRM-044-V0-E`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-044-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 5 | Cargar 1 u de `QA-PRM-044-V0-B` por código. | `QA-PRM-044-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-044-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.700,00**. |
| 6 | Seleccionar `QA-PRM-044-V0-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-044-V0-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal<br>`QA-PRM-044-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$2.550,00**. |
| 7 | Seleccionar `QA-PRM-044-V0-B`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-044-V0-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal | Total **$1.700,00**. |
| 8 | Seleccionar `QA-PRM-044-V0-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-044-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
...
| 11 | Cargar 1 u de `QA-PRM-044-V0-A` por código. | `QA-PRM-044-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 12 | Cargar 1 u de `QA-PRM-044-V0-B` por código. | `QA-PRM-044-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-044-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.700,00**. |
| 13 | Abrir cobro en efectivo del perfil QA, ingresar $1.700,00 y cancelar antes de confirmar. | `QA-PRM-044-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-044-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.700,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 14 | Retomar el cobro en efectivo del perfil QA, ingresar $1.700,00 y confirmar una sola vez. | `QA-PRM-044-V0-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-044-V0-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.700,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-044-V0-A` −1 u; `QA-PRM-044-V0-B` −1 u. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-044-V1-A` | $1.000,00 | unidad | 985410 / 985411 / 985410 | QA-PRM-044-V1-MARCA |
| B | `QA-PRM-044-V1-B` | $1.000,00 | unidad | 985410 / 985412 / 985410 | QA-PRM-044-V1-MARCA |
| E | `QA-PRM-044-V1-E` | $1.000,00 | unidad | 985419 / 985419 / 985410 | QA-PRM-044-V1-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-044-V1` | Familia `985410` | Desde 2: $150,00 de descuento por unidad | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| ---: | --- | --- | --- |
| 1 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 2 | Cargar 1 u de `QA-PRM-044-V1-A` por código. | `QA-PRM-044-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-044-V1-B` por código. | `QA-PRM-044-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-044-V1-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Seleccionar `QA-PRM-044-V1-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-044-V1-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal<br>`QA-PRM-044-V1-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.700,00**. |
...
- **NUEVO PENDIENTE DE PREPARAR:** perfil QA-XG-PRM-044, productos A y B exclusivos de una misma familia, un producto Ajeno de otra familia y la oferta indicada. Son nombres funcionales propuestos, sin IDs asignados ni filas disponibles en el seed actual. Preparar dos copias del perfil: agrupación activada y desactivada, con idénticos datos y una sola regla comercial.
...
3. Quitar Ajeno y agregar B ×1. **Esperado:** dos productos distintos incluidos, bruto $2.000,00, descuento $300,00, neto $1.700,00. Las dos unidades combinadas alcanzan la condición aunque ninguna fila tenga dos unidades.
