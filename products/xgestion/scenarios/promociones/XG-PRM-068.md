---
{"id":"XG-PRM-068","title":"Elegir la oferta elegible por cantidad y fecha dentro del mismo alcance","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-condiciones","ofertas-producto","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/condiciones.robot","seed":"catalogo-comercial-v1"}
---
...
Elegir la oferta elegible por cantidad y fecha dentro del mismo alcance durante una venta, con importes y efectos observables por el vendedor o cajero.
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-068 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
## Variante 1: cantidad-y-fecha

### Productos preparados

| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-068-PRIORIDAD` | $1.000,00 | unidad | 980001 / 980001 / 980001 | QA-SEED |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-068-MIN2` | Producto `QA-PRM-068-PRIORIDAD` | Desde 2: precio final $900,00 por unidad | OFF | Activa; hoy -30 días a hoy +365 días | Todos |
| `QA-PRM-068-MIN3-ANTERIOR` | Producto `QA-PRM-068-PRIORIDAD` | Desde 3: precio final $850,00 por unidad | OFF | Activa; hoy -20 días a hoy +365 días | Todos |
| `QA-PRM-068-MIN3-RECIENTE` | Producto `QA-PRM-068-PRIORIDAD` | Desde 3: precio final $800,00 por unidad | OFF | Activa; hoy -10 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-068-PRIORIDAD` por código. | `QA-PRM-068-PRIORIDAD` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Seleccionar `QA-PRM-068-PRIORIDAD`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-068-PRIORIDAD` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 4 | Seleccionar `QA-PRM-068-PRIORIDAD`, abrir Ctrl+E, dejar 3 u y guardar. | `QA-PRM-068-PRIORIDAD` × 3 u: precio $1.000,00; automático $600,00; manual $0,00; neto $2.400,00; lista aplicada: precio normal | Total **$2.400,00**. |
| 5 | Seleccionar `QA-PRM-068-PRIORIDAD`, abrir Ctrl+E, dejar 4 u y guardar. | `QA-PRM-068-PRIORIDAD` × 4 u: precio $1.000,00; automático $800,00; manual $0,00; neto $3.200,00; lista aplicada: precio normal | Total **$3.200,00**. |
| 6 | Seleccionar `QA-PRM-068-PRIORIDAD`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-068-PRIORIDAD` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 7 | Seleccionar `QA-PRM-068-PRIORIDAD`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-068-PRIORIDAD` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 8 | Seleccionar `QA-PRM-068-PRIORIDAD`, abrir Ctrl+E, dejar 3 u y guardar. | `QA-PRM-068-PRIORIDAD` × 3 u: precio $1.000,00; automático $600,00; manual $0,00; neto $2.400,00; lista aplicada: precio normal | Total **$2.400,00**. |
| 9 | Abrir cobro en efectivo del perfil QA, ingresar $2.400,00 y cancelar antes de confirmar. | `QA-PRM-068-PRIORIDAD` × 3 u: precio $1.000,00; automático $600,00; manual $0,00; neto $2.400,00; lista aplicada: precio normal | Total **$2.400,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 10 | Retomar el cobro en efectivo del perfil QA, ingresar $2.400,00 y confirmar una sola vez. | `QA-PRM-068-PRIORIDAD` × 3 u: precio $1.000,00; automático $600,00; manual $0,00; neto $2.400,00; lista aplicada: precio normal | Total **$2.400,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-068-PRIORIDAD` −3 u. |
...
- Nuevo producto de $1.000 con tres ofertas de precio unitario final: desde 2 unidades a $900, desde 3 a $850 con inicio anterior, desde 3 a $800 con inicio posterior. Todas vigentes. Fechas de inicio distintas anteriores al día de la prueba; sin empate de IDs ni otros alcances.
...
| --- | --- |
| Cargar una unidad. | Neto $1.000; ninguna oferta llega al mínimo. |
| Editar a dos unidades. | Neto $1.800; se elige el mínimo de dos. |
| Editar a tres y luego cuatro unidades. | Netos $2.400 y $3.200; entre las de mínimo tres se elige la de inicio más reciente. |
| Reducir a dos y luego una unidad. | Netos $1.800 y $1.000; no queda arrastrada la oferta anterior. |
| Volver a tres, cancelar el cobro y retomarlo por $2.400. | Un único cobro; precio y oferta del mínimo tres más reciente. |

## Dependencias para automatizar

Fixture nuevo con vigencias verificables, más de una candidata de igual alcance y lectura de identidad de la oferta. Un empate completo requiere una futura ficha específica.
...
Rutas relativas a XGestion2: `test/ModuloFinanzas/Entidades/OfertaAplicabilidadTest.java`; `src/ModuloFinanzas/Entidades/Oferta.java`.
