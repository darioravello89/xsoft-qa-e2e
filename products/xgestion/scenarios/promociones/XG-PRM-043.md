---
{"id":"XG-PRM-043","title":"Agrupar por familia: 10 % desde dos unidades combinadas","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-agrupadas","ofertas-familia","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/agrupadas.robot","seed":"catalogo-comercial-v1"}
---
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-043 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-043-V0-A` | $1.000,00 | unidad | 985300 / 985301 / 985300 | QA-PRM-043-V0-MARCA |
| B | `QA-PRM-043-V0-B` | $1.000,00 | unidad | 985300 / 985302 / 985300 | QA-PRM-043-V0-MARCA |
| E | `QA-PRM-043-V0-E` | $1.000,00 | unidad | 985309 / 985309 / 985300 | QA-PRM-043-V0-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-043-V0` | Familia `985300` | Desde 2: 10 % sobre toda la cantidad | ON | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-043-V0-A` por código. | `QA-PRM-043-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-043-V0-E` por código. | `QA-PRM-043-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-043-V0-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Seleccionar `QA-PRM-043-V0-E`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-043-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 5 | Cargar 1 u de `QA-PRM-043-V0-B` por código. | `QA-PRM-043-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal<br>`QA-PRM-043-V0-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 6 | Seleccionar `QA-PRM-043-V0-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-043-V0-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal<br>`QA-PRM-043-V0-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$2.700,00**. |
| 7 | Seleccionar `QA-PRM-043-V0-B`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-043-V0-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 8 | Seleccionar `QA-PRM-043-V0-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-043-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
...
| 11 | Cargar 1 u de `QA-PRM-043-V0-A` por código. | `QA-PRM-043-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 12 | Cargar 1 u de `QA-PRM-043-V0-B` por código. | `QA-PRM-043-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal<br>`QA-PRM-043-V0-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 13 | Abrir cobro en efectivo del perfil QA, ingresar $1.800,00 y cancelar antes de confirmar. | `QA-PRM-043-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal<br>`QA-PRM-043-V0-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$1.800,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 14 | Retomar el cobro en efectivo del perfil QA, ingresar $1.800,00 y confirmar una sola vez. | `QA-PRM-043-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal<br>`QA-PRM-043-V0-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$1.800,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-043-V0-A` −1 u; `QA-PRM-043-V0-B` −1 u. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-043-V1-A` | $1.000,00 | unidad | 985310 / 985311 / 985310 | QA-PRM-043-V1-MARCA |
| B | `QA-PRM-043-V1-B` | $1.000,00 | unidad | 985310 / 985312 / 985310 | QA-PRM-043-V1-MARCA |
| E | `QA-PRM-043-V1-E` | $1.000,00 | unidad | 985319 / 985319 / 985310 | QA-PRM-043-V1-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-043-V1` | Familia `985310` | Desde 2: 10 % sobre toda la cantidad | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| ---: | --- | --- | --- |
| 1 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 2 | Cargar 1 u de `QA-PRM-043-V1-A` por código. | `QA-PRM-043-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-043-V1-B` por código. | `QA-PRM-043-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-043-V1-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Seleccionar `QA-PRM-043-V1-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-043-V1-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal<br>`QA-PRM-043-V1-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.800,00**. |
...
- **NUEVO PENDIENTE DE PREPARAR:** perfil QA-XG-PRM-043, productos A y B exclusivos de una misma familia, un producto Ajeno de otra familia y la oferta indicada. Son nombres funcionales propuestos, sin IDs asignados ni filas disponibles en el seed actual. Preparar dos copias del perfil: agrupación activada y desactivada, con idénticos datos y una sola regla comercial.
- A y B pertenecen a la misma familia. Ajeno tiene otra familia aunque comparta marca o sector; no usar esos atributos como criterio de inclusión.
...
1. Abrir una venta vacía con agrupación **activada** y cargar A ×1. **Esperado:** bruto $1.000,00, descuento $0,00, neto $1.000,00.

2. Agregar Ajeno ×1, conservando A ×1. **Esperado:** bruto $2.000,00, descuento $0,00, neto $2.000,00. Ajeno conserva neto $1.000,00 y no participa en el beneficio ni en su mínimo.

3. Quitar Ajeno y agregar B ×1. **Esperado:** dos productos distintos incluidos, bruto $2.000,00, descuento $200,00, neto $1.800,00. Las dos unidades combinadas alcanzan la condición aunque ninguna fila tenga dos unidades.

4. Editar A de ×1 a ×2. **Esperado:** A ×2 + B ×1, bruto $3.000,00, descuento $300,00, neto $2.700,00. Quitar B. **Esperado:** A ×2, bruto $2.000,00, descuento $200,00, neto $1.800,00.

5. Reducir A a ×1. **Esperado:** bruto $1.000,00, descuento $0,00, neto $1.000,00; no conserva un descuento de la cantidad anterior. Abandonar y confirmar. **Esperado:** no queda una venta cobrada ni movimientos de stock/caja.

6. En una ejecución independiente restaurada, usar la copia con agrupación **desactivada**. Cargar A ×1 + B ×1. **Esperado:** bruto $2.000,00, descuento $0,00, neto $2.000,00. Cambiar A a ×2. **Esperado:** bruto $3.000,00, descuento $200,00, neto $2.800,00. Se evalúa cada producto por separado; B no completa el mínimo de A ni recibe su beneficio. Abandonar sin efectos.

7. Restaurar el perfil agrupado inicial y cargar A ×1 + B ×1. Abrir y cancelar el cobro. **Esperado:** se conserva neto $1.800,00 y no se registra venta cobrada ni cambios en stock/caja. Retomar el cobro y confirmar una sola vez $1.800,00 en efectivo. **Esperado:** una venta y un cobro por ese importe, caja +$1.800,00, stock A −1 y B −1; Ajeno sin cambios.
