---
{"id":"XG-PRM-074","title":"Aplicar una oferta exclusiva de efectivo y rechazar otros medios","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-condiciones","cobros","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/medios-pago.robot","seed":"catalogo-comercial-v1"}
---
...
Aplicar una oferta exclusiva de efectivo y rechazar otros medios durante una venta, con importes y efectos observables por el vendedor o cajero.
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-074 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-074-V0-A` | $1.000,00 | unidad | 980001 / 980001 / 980001 | QA-SEED |
| B | `QA-PRM-074-V0-CONTROL` | $1.000,00 | unidad | 980001 / 980001 / 980001 | QA-SEED |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-074-V0` | Producto `QA-PRM-074-V0-A` | 10 % sobre el importe | OFF | Activa; hoy -365 días a hoy +365 días | QA-PRM-EFECTIVO |
| `QA-PRM-074-V0-TODOS` | Producto `QA-PRM-074-V0-CONTROL` | 10 % sobre el importe | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 3 | Cargar 1 u de `QA-PRM-074-V0-A` por código. | `QA-PRM-074-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. |
| 4 | Cargar 1 u de `QA-PRM-074-V0-A` por código. | `QA-PRM-074-V0-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. |
...
| 7 | Elegir `QA-PRM-EFECTIVO` y comprobar el recálculo. | Sin renglones en la operación. | Total **$0,00**. |
| 8 | Cargar 2 u de `QA-PRM-074-V0-A` por código. | `QA-PRM-074-V0-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 9 | Seleccionar `QA-PRM-074-V0-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-074-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. |
| 10 | Abrir cobro en `QA-PRM-EFECTIVO`, ingresar $900,00 y cancelar antes de confirmar. | `QA-PRM-074-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 11 | Retomar el cobro en `QA-PRM-EFECTIVO`, ingresar $900,00 y confirmar una sola vez. | `QA-PRM-074-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. Una venta y un cobro en `QA-PRM-EFECTIVO`; vuelto cero. Stock: `QA-PRM-074-V0-A` −1 u. |
| 12 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 13 | Elegir `QA-PRM-EFECTIVO` y comprobar el recálculo. | Sin renglones en la operación. | Total **$0,00**. |
| 14 | Cargar 1 u de `QA-PRM-074-V0-CONTROL` por código. | `QA-PRM-074-V0-CONTROL` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. |
| 15 | Abandonar la venta y confirmar la salida sin cobrar. | Sin renglones en la operación. | Sin venta cobrada, pago ni cambios de stock o destino de cobro. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-074-V1-A` | $1.000,00 | unidad | 980001 / 980001 / 980001 | QA-SEED |
| B | `QA-PRM-074-V1-CONTROL` | $1.000,00 | unidad | 980001 / 980001 / 980001 | QA-SEED |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-074-V1` | Producto `QA-PRM-074-V1-A` | 10 % sobre el importe | OFF | Activa; hoy -365 días a hoy +365 días | QA-PRM-EFECTIVO |
| `QA-PRM-074-V1-TODOS` | Producto `QA-PRM-074-V1-CONTROL` | 10 % sobre el importe | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| ---: | --- | --- | --- |
| 1 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 2 | Elegir `QA-PRM-TARJETA` y comprobar el recálculo. | Sin renglones en la operación. | Total **$0,00**. |
| 3 | Cargar 1 u de `QA-PRM-074-V1-A` por código. | `QA-PRM-074-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 4 | Cargar 1 u de `QA-PRM-074-V1-A` por código. | `QA-PRM-074-V1-A` × 2 u: precio $1.000,00; automático $0,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 5 | Abandonar la venta y confirmar la salida sin cobrar. | Sin renglones en la operación. | Sin venta cobrada, pago ni cambios de stock o destino de cobro. |
| 6 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 7 | Elegir `QA-PRM-TARJETA` y comprobar el recálculo. | Sin renglones en la operación. | Total **$0,00**. |
| 8 | Cargar 2 u de `QA-PRM-074-V1-A` por código. | `QA-PRM-074-V1-A` × 2 u: precio $1.000,00; automático $0,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 9 | Seleccionar `QA-PRM-074-V1-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-074-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 10 | Abrir cobro en `QA-PRM-TARJETA`, ingresar $1.000,00 y cancelar antes de confirmar. | `QA-PRM-074-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 11 | Retomar el cobro en `QA-PRM-TARJETA`, ingresar $1.000,00 y confirmar una sola vez. | `QA-PRM-074-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. Una venta y un cobro en `QA-PRM-TARJETA`; vuelto cero. Stock: `QA-PRM-074-V1-A` −1 u. |
| 12 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 13 | Elegir `QA-PRM-TARJETA` y comprobar el recálculo. | Sin renglones en la operación. | Total **$0,00**. |
| 14 | Cargar 1 u de `QA-PRM-074-V1-CONTROL` por código. | `QA-PRM-074-V1-CONTROL` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. |
| 15 | Abandonar la venta y confirmar la salida sin cobrar. | Sin renglones en la operación. | Sin venta cobrada, pago ni cambios de stock o destino de cobro. |
...
- Producto nuevo de $1.000 con 10% solo para Efectivo. Tarjeta manual offline activa, sin recargo ni descuento; una oferta de control independiente y aplicable a Todos. No ejecutar con pasarela de pagos.
...
| --- | --- |
| Seleccionar efectivo y cargar dos unidades. | Bruto $2.000, oferta $200, neto $1.800. |
| Abandonar sin cobrar y abrir otra venta con tarjeta manual. | Dos unidades cuestan $2.000, oferta $0; el control de Todos sigue funcionando en su corrida separada. |
| En tarjeta, editar a una unidad y cancelar el cobro. | Neto $1.000 sin movimientos ni descuento de efectivo. |
| Comenzar una nueva corrida en efectivo y pagar una unidad. | Neto y pago $900; una única venta en esa corrida. |

## Dependencias para automatizar

Fixtures de medios manuales, selectores y oráculos pendientes de ampliar. Cada variante se informa por medio y perfil, sin confundir fallo de entorno con rechazo comercial.
...
Rutas relativas a XGestion2: `test/ModuloFinanzas/Entidades/OfertaTiposCobroTest.java`; `test/ModuloFinanzas/Entidades/OfertaAplicabilidadTest.java`.
