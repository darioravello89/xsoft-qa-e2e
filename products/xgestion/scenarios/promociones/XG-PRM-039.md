---
{"id":"XG-PRM-039","title":"Agrupar por familia: 10 % entre productos","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-agrupadas","ofertas-familia","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/agrupadas.robot","seed":"catalogo-comercial-v1"}
---
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-039 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-039-V0-A` | $1.000,00 | unidad | 984900 / 984901 / 984900 | QA-PRM-039-V0-MARCA |
| B | `QA-PRM-039-V0-B` | $1.000,00 | unidad | 984900 / 984902 / 984900 | QA-PRM-039-V0-MARCA |
| E | `QA-PRM-039-V0-E` | $1.000,00 | unidad | 984909 / 984909 / 984900 | QA-PRM-039-V0-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-039-V0` | Familia `984900` | 10 % sobre el importe | ON | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-039-V0-A` por código. | `QA-PRM-039-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. |
| 3 | Cargar 1 u de `QA-PRM-039-V0-E` por código. | `QA-PRM-039-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal<br>`QA-PRM-039-V0-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.900,00**. |
| 4 | Seleccionar `QA-PRM-039-V0-E`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-039-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. |
| 5 | Cargar 1 u de `QA-PRM-039-V0-B` por código. | `QA-PRM-039-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal<br>`QA-PRM-039-V0-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 6 | Seleccionar `QA-PRM-039-V0-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-039-V0-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal<br>`QA-PRM-039-V0-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$2.700,00**. |
| 7 | Seleccionar `QA-PRM-039-V0-B`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-039-V0-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 8 | Seleccionar `QA-PRM-039-V0-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-039-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. |
...
| 11 | Cargar 1 u de `QA-PRM-039-V0-A` por código. | `QA-PRM-039-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. |
| 12 | Cargar 1 u de `QA-PRM-039-V0-B` por código. | `QA-PRM-039-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal<br>`QA-PRM-039-V0-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 13 | Abrir cobro en efectivo del perfil QA, ingresar $1.800,00 y cancelar antes de confirmar. | `QA-PRM-039-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal<br>`QA-PRM-039-V0-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$1.800,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 14 | Retomar el cobro en efectivo del perfil QA, ingresar $1.800,00 y confirmar una sola vez. | `QA-PRM-039-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal<br>`QA-PRM-039-V0-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$1.800,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-039-V0-A` −1 u; `QA-PRM-039-V0-B` −1 u. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-039-V1-A` | $1.000,00 | unidad | 984910 / 984911 / 984910 | QA-PRM-039-V1-MARCA |
| B | `QA-PRM-039-V1-B` | $1.000,00 | unidad | 984910 / 984912 / 984910 | QA-PRM-039-V1-MARCA |
| E | `QA-PRM-039-V1-E` | $1.000,00 | unidad | 984919 / 984919 / 984910 | QA-PRM-039-V1-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-039-V1` | Familia `984910` | 10 % sobre el importe | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| ---: | --- | --- | --- |
| 1 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 2 | Cargar 1 u de `QA-PRM-039-V1-A` por código. | `QA-PRM-039-V1-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. |
| 3 | Cargar 1 u de `QA-PRM-039-V1-B` por código. | `QA-PRM-039-V1-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal<br>`QA-PRM-039-V1-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 4 | Seleccionar `QA-PRM-039-V1-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-039-V1-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal<br>`QA-PRM-039-V1-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$2.700,00**. |
...
- **NUEVO PENDIENTE DE PREPARAR:** perfil QA-XG-PRM-039, productos A y B exclusivos de una misma familia, un producto Ajeno de otra familia y la oferta indicada. Son nombres funcionales propuestos, sin IDs asignados ni filas disponibles en el seed actual. Preparar dos copias del perfil: agrupación activada y desactivada, con idénticos datos y una sola regla comercial.
