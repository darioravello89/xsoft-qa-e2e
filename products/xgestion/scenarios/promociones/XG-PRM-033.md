---
{"id":"XG-PRM-033","title":"Descontar $150 por unidad por sector","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-alcances","ofertas-sector","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/sector.robot","seed":"catalogo-comercial-v1"}
---
...
El vendedor comprueba $150 de descuento por unidad por sector, distingue los productos incluidos de los ajenos y conserva el importe correcto al corregir cantidades y retomar un cobro.
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-033 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-033-A` | $1.000,00 | unidad | 984300 / 984300 / 984300 | QA-SEED |
| B | `QA-PRM-033-B` | $1.000,00 | unidad | 984301 / 984301 / 984300 | QA-SEED |
| E | `QA-PRM-033-E` | $1.000,00 | unidad | 984300 / 984300 / 984309 | QA-SEED |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-033` | Sector `984300` | $150,00 de descuento por unidad | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-033-E` por código. | `QA-PRM-033-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-033-A` por código. | `QA-PRM-033-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-033-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.850,00**. |
| 4 | Seleccionar `QA-PRM-033-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-033-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-033-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal | Total **$2.700,00**. |
| 5 | Seleccionar `QA-PRM-033-A`, abrir Ctrl+E, dejar 3 u y guardar. | `QA-PRM-033-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-033-A` × 3 u: precio $1.000,00; automático $450,00; manual $0,00; neto $2.550,00; lista aplicada: precio normal | Total **$3.550,00**. |
| 6 | Seleccionar `QA-PRM-033-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-033-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-033-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$1.850,00**. |
| 7 | Cargar 1 u de `QA-PRM-033-B` por código. | `QA-PRM-033-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-033-A` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal<br>`QA-PRM-033-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$2.700,00**. |
| 8 | Seleccionar `QA-PRM-033-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-033-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-033-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal<br>`QA-PRM-033-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$3.550,00**. |
| 9 | Abrir cobro en efectivo del perfil QA, ingresar $3.550,00 y cancelar antes de confirmar. | `QA-PRM-033-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-033-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal<br>`QA-PRM-033-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$3.550,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 10 | Retomar el cobro en efectivo del perfil QA, ingresar $3.550,00 y confirmar una sola vez. | `QA-PRM-033-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-033-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal<br>`QA-PRM-033-B` × 1 u: precio $1.000,00; automático $150,00; manual $0,00; neto $850,00; lista aplicada: precio normal | Total **$3.550,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-033-E` −1 u; `QA-PRM-033-A` −2 u; `QA-PRM-033-B` −1 u. |
...
- Regla: **$150 de descuento por cada unidad, sin cantidad mínima.** Agrupación **desactivada**: cada producto se evalúa por separado; sector no admite el modo de agrupación de productos.
- **Fixture nuevo pendiente de preparar:** `xg-prm-033-alcance-v1`. A = `QA-PEND-PRM-033-A` y B = `QA-PEND-PRM-033-B` son identificadores propuestos, todavía ausentes del seed; deben tener una clasificación exclusiva para esta oferta. E = `QA-SEED-NORMAL` puede reutilizarse del catálogo base y debe quedar fuera del alcance.
...
| 3 | Cargar A (`QA-PEND-PRM-033-A`), cantidad 1. | A: bruto $1.000,00, descuento $150,00, neto $850,00. E continúa en $1.000,00; total de venta $1.850,00. |
...
| 7 | Cargar B (`QA-PEND-PRM-033-B`), cantidad 1, sin modificar A. | A y B se calculan por separado: cada uno queda en $850,00; E sigue en $1.000,00; total $2.700,00. Ambos productos incluidos reciben el beneficio y E queda excluido. |
