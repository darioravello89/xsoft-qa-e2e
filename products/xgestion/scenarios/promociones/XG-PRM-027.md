---
{"id":"XG-PRM-027","title":"Aplicar un 2x1 por marca","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-alcances","ofertas-marca","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/marca.robot","seed":"catalogo-comercial-v1"}
---
...
El vendedor comprueba lleva 2 y paga 1 por marca, distingue los productos incluidos de los ajenos y conserva el importe correcto al corregir cantidades y retomar un cobro.
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-027 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-027-A` | $1.000,00 | unidad | 983700 / 983700 / 980001 | QA-PRM-027-MARCA |
| B | `QA-PRM-027-B` | $1.000,00 | unidad | 983701 / 983701 / 980001 | QA-PRM-027-MARCA |
| E | `QA-PRM-027-E` | $1.000,00 | unidad | 983700 / 983700 / 980001 | QA-PRM-027-OTRA-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-027` | Marca `QA-PRM-027-MARCA` | Llevar 2 y pagar 1 | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-027-E` por código. | `QA-PRM-027-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-027-A` por código. | `QA-PRM-027-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-027-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Seleccionar `QA-PRM-027-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-027-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-027-A` × 2 u: precio $1.000,00; automático $1.000,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 5 | Seleccionar `QA-PRM-027-A`, abrir Ctrl+E, dejar 3 u y guardar. | `QA-PRM-027-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-027-A` × 3 u: precio $1.000,00; automático $1.000,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 6 | Seleccionar `QA-PRM-027-A`, abrir Ctrl+E, dejar 4 u y guardar. | `QA-PRM-027-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-027-A` × 4 u: precio $1.000,00; automático $2.000,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 7 | Seleccionar `QA-PRM-027-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-027-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-027-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 8 | Cargar 1 u de `QA-PRM-027-B` por código. | `QA-PRM-027-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-027-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-027-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 9 | Seleccionar `QA-PRM-027-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-027-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-027-A` × 2 u: precio $1.000,00; automático $1.000,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-027-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 10 | Abrir cobro en efectivo del perfil QA, ingresar $3.000,00 y cancelar antes de confirmar. | `QA-PRM-027-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-027-A` × 2 u: precio $1.000,00; automático $1.000,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-027-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.000,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 11 | Retomar el cobro en efectivo del perfil QA, ingresar $3.000,00 y confirmar una sola vez. | `QA-PRM-027-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-027-A` × 2 u: precio $1.000,00; automático $1.000,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-027-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.000,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-027-E` −1 u; `QA-PRM-027-A` −2 u; `QA-PRM-027-B` −1 u. |
...
- **Fixture nuevo pendiente de preparar:** `xg-prm-027-alcance-v1`. A = `QA-PEND-PRM-027-A` y B = `QA-PEND-PRM-027-B` son identificadores propuestos, todavía ausentes del seed; deben tener una clasificación exclusiva para esta oferta. E = `QA-SEED-NORMAL` puede reutilizarse del catálogo base y debe quedar fuera del alcance.
...
| 3 | Cargar A (`QA-PEND-PRM-027-A`), cantidad 1. | A: bruto $1.000,00, descuento $0,00, neto $1.000,00. E continúa en $1.000,00; total de venta $2.000,00. |
...
| 8 | Cargar B (`QA-PEND-PRM-027-B`), cantidad 1, sin modificar A. | A y B se calculan por separado: cada uno queda en $1.000,00; E sigue en $1.000,00; total $3.000,00. Aunque A+B suman dos unidades del alcance, ninguno alcanza por separado el mínimo; no hay beneficio agrupado. |
