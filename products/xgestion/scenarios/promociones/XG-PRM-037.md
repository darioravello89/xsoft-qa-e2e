---
{"id":"XG-PRM-037","title":"Descontar $150 por unidad desde dos unidades por sector","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-alcances","ofertas-sector","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/sector.robot","seed":"catalogo-comercial-v1"}
---
...
El vendedor comprueba $150 menos por unidad desde 2 por sector, distingue los productos incluidos de los ajenos y conserva el importe correcto al corregir cantidades y retomar un cobro.
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-037 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-037-A` | $1.000,00 | unidad | 984700 / 984700 / 984700 | QA-SEED |
| B | `QA-PRM-037-B` | $1.000,00 | unidad | 984701 / 984701 / 984700 | QA-SEED |
| E | `QA-PRM-037-E` | $1.000,00 | unidad | 984700 / 984700 / 984709 | QA-SEED |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-037` | Sector `984700` | Desde 2: $150,00 de descuento por unidad | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-037-E` por código. | `QA-PRM-037-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-037-A` por código. | `QA-PRM-037-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-037-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Seleccionar `QA-PRM-037-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-037-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-037-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal | Total **$2.700,00**. |
| 5 | Seleccionar `QA-PRM-037-A`, abrir Ctrl+E, dejar 3 u y guardar. | `QA-PRM-037-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-037-A` × 3 u: precio $1.000,00; automático $450,00; manual $0,00; neto $2.550,00; lista aplicada: precio normal | Total **$3.550,00**. |
| 6 | Seleccionar `QA-PRM-037-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-037-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-037-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 7 | Cargar 1 u de `QA-PRM-037-B` por código. | `QA-PRM-037-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-037-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-037-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 8 | Seleccionar `QA-PRM-037-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-037-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-037-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal<br>`QA-PRM-037-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.700,00**. |
| 9 | Abrir cobro en efectivo del perfil QA, ingresar $3.700,00 y cancelar antes de confirmar. | `QA-PRM-037-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-037-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal<br>`QA-PRM-037-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.700,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 10 | Retomar el cobro en efectivo del perfil QA, ingresar $3.700,00 y confirmar una sola vez. | `QA-PRM-037-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-037-A` × 2 u: precio $1.000,00; automático $300,00; manual $0,00; neto $1.700,00; lista aplicada: precio normal<br>`QA-PRM-037-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.700,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-037-E` −1 u; `QA-PRM-037-A` −2 u; `QA-PRM-037-B` −1 u. |
...
- Regla: **Desde 2 unidades del mismo producto, descuento de $150 en cada unidad.** Agrupación **desactivada**: cada producto se evalúa por separado; sector no admite el modo de agrupación de productos.
- **Fixture nuevo pendiente de preparar:** `xg-prm-037-alcance-v1`. A = `QA-PEND-PRM-037-A` y B = `QA-PEND-PRM-037-B` son identificadores propuestos, todavía ausentes del seed; deben tener una clasificación exclusiva para esta oferta. E = `QA-SEED-NORMAL` puede reutilizarse del catálogo base y debe quedar fuera del alcance.
...
El mínimo es inclusivo: a cantidad 2 se descuentan $300 y a cantidad 3, $450. Al volver a 1 desaparece el beneficio.
...
| 3 | Cargar A (`QA-PEND-PRM-037-A`), cantidad 1. | A: bruto $1.000,00, descuento $0,00, neto $1.000,00. E continúa en $1.000,00; total de venta $2.000,00. |
| 4 | Editar la misma línea A mediante Ctrl+E y dejar cantidad 2. | A: bruto $2.000,00, descuento $300,00, neto $1.700,00; total $2.700,00. Se alcanza exactamente el mínimo. |
...
| 7 | Cargar B (`QA-PEND-PRM-037-B`), cantidad 1, sin modificar A. | A y B se calculan por separado: cada uno queda en $1.000,00; E sigue en $1.000,00; total $3.000,00. Aunque A+B suman dos unidades del alcance, ninguno alcanza por separado el mínimo; no hay beneficio agrupado. |
| 8 | Editar A nuevamente a cantidad 2. | A queda en $1.700,00, B en $1.000,00 y E en $1.000,00; total $3.700,00. Se mantienen identidades y una línea por producto. |
...
Fuente inspeccionada: XGestion2 commit `4b80ca6af137d1a7c06ac6d4545e1c08f9f21f1a`. Alcance `ofeTipo=1`; fórmula `TipoDescuento=LXO+$`, `Lleva=2`, `Paga=150`; agrupación OFF. `src/ModuloFinanzas/Entidades/Oferta.java`, método `seleccionarOfertaAplicable`, selecciona por identidad/clasificación, vigencia, sucursal y pago. `src/ModuloFinanzas/Entidades/OfertaCalculador.java` y `test/ModuloFinanzas/Entidades/OfertaCantidadMayorImporteTest.java` sustentan la aritmética; `OfertaAplicacionCalculador.java` distingue cálculo individual y agrupado. Revisar integración en `src/ModuloVentas/Vistas/FormVenta.java` sobre el JAR al implementar.
