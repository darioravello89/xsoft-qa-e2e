---
{"id":"XG-PRM-041","title":"Agrupar por familia: 3x2 entre productos","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-agrupadas","ofertas-familia","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/agrupadas.robot","seed":"catalogo-comercial-v1"}
---
...
El vendedor combina artículos de una misma familia, comprueba qué beneficio corresponde y corrige la venta sin conservar descuentos que ya no corresponden.
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-041 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-041-V0-A` | $1.000,00 | unidad | 985100 / 985101 / 985100 | QA-PRM-041-V0-MARCA |
| B | `QA-PRM-041-V0-B` | $1.000,00 | unidad | 985100 / 985102 / 985100 | QA-PRM-041-V0-MARCA |
| C | `QA-PRM-041-V0-C` | $1.000,00 | unidad | 985100 / 985103 / 985100 | QA-PRM-041-V0-MARCA |
| E | `QA-PRM-041-V0-E` | $1.000,00 | unidad | 985109 / 985109 / 985100 | QA-PRM-041-V0-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-041-V0` | Familia `985100` | Llevar 3 y pagar 2 | ON | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-041-V0-A` por código. | `QA-PRM-041-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-041-V0-E` por código. | `QA-PRM-041-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-041-V0-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Cargar 1 u de `QA-PRM-041-V0-B` por código. | `QA-PRM-041-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-041-V0-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-041-V0-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 5 | Seleccionar `QA-PRM-041-V0-E`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-041-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-041-V0-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 6 | Cargar 1 u de `QA-PRM-041-V0-C` por código. | `QA-PRM-041-V0-A` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-041-V0-B` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-041-V0-C` × 1 u: precio $1.000,00; automático $333,34; manual $0,00; neto $666,66; lista aplicada: precio normal | Total **$2.000,00**. |
| 7 | Seleccionar `QA-PRM-041-V0-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-041-V0-A` × 2 u: precio $1.000,00; automático $500,00; manual $0,00; neto $1.500,00; lista aplicada: precio normal<br>`QA-PRM-041-V0-B` × 1 u: precio $1.000,00; automático $250,00; manual $0,00; neto $750,00; lista aplicada: precio normal<br>`QA-PRM-041-V0-C` × 1 u: precio $1.000,00; automático $250,00; manual $0,00; neto $750,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 8 | Seleccionar `QA-PRM-041-V0-C`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-041-V0-A` × 2 u: precio $1.000,00; automático $666,67; manual $0,00; neto $1.333,33; lista aplicada: precio normal<br>`QA-PRM-041-V0-B` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal | Total **$2.000,00**. |
| 9 | Seleccionar `QA-PRM-041-V0-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-041-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-041-V0-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
...
| 12 | Cargar 1 u de `QA-PRM-041-V0-A` por código. | `QA-PRM-041-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 13 | Cargar 1 u de `QA-PRM-041-V0-B` por código. | `QA-PRM-041-V0-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-041-V0-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 14 | Cargar 1 u de `QA-PRM-041-V0-C` por código. | `QA-PRM-041-V0-A` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-041-V0-B` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-041-V0-C` × 1 u: precio $1.000,00; automático $333,34; manual $0,00; neto $666,66; lista aplicada: precio normal | Total **$2.000,00**. |
| 15 | Abrir cobro en efectivo del perfil QA, ingresar $2.000,00 y cancelar antes de confirmar. | `QA-PRM-041-V0-A` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-041-V0-B` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-041-V0-C` × 1 u: precio $1.000,00; automático $333,34; manual $0,00; neto $666,66; lista aplicada: precio normal | Total **$2.000,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 16 | Retomar el cobro en efectivo del perfil QA, ingresar $2.000,00 y confirmar una sola vez. | `QA-PRM-041-V0-A` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-041-V0-B` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-041-V0-C` × 1 u: precio $1.000,00; automático $333,34; manual $0,00; neto $666,66; lista aplicada: precio normal | Total **$2.000,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-041-V0-A` −1 u; `QA-PRM-041-V0-B` −1 u; `QA-PRM-041-V0-C` −1 u. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-041-V1-A` | $1.000,00 | unidad | 985110 / 985111 / 985110 | QA-PRM-041-V1-MARCA |
| B | `QA-PRM-041-V1-B` | $1.000,00 | unidad | 985110 / 985112 / 985110 | QA-PRM-041-V1-MARCA |
| C | `QA-PRM-041-V1-C` | $1.000,00 | unidad | 985110 / 985113 / 985110 | QA-PRM-041-V1-MARCA |
| E | `QA-PRM-041-V1-E` | $1.000,00 | unidad | 985119 / 985119 / 985110 | QA-PRM-041-V1-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-041-V1` | Familia `985110` | Llevar 3 y pagar 2 | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| ---: | --- | --- | --- |
| 1 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 2 | Cargar 1 u de `QA-PRM-041-V1-A` por código. | `QA-PRM-041-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-041-V1-B` por código. | `QA-PRM-041-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-041-V1-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Cargar 1 u de `QA-PRM-041-V1-C` por código. | `QA-PRM-041-V1-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-041-V1-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-041-V1-C` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 5 | Seleccionar `QA-PRM-041-V1-A`, abrir Ctrl+E, dejar 3 u y guardar. | `QA-PRM-041-V1-A` × 3 u: precio $1.000,00; automático $1.000,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal<br>`QA-PRM-041-V1-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-041-V1-C` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$4.000,00**. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-041-V2-A` | $1.000,00 | unidad | 985120 / 985121 / 985120 | QA-PRM-041-V2-MARCA |
| B | `QA-PRM-041-V2-B` | $2.000,00 | unidad | 985120 / 985122 / 985120 | QA-PRM-041-V2-MARCA |
| C | `QA-PRM-041-V2-C` | $3.000,00 | unidad | 985120 / 985123 / 985120 | QA-PRM-041-V2-MARCA |
| E | `QA-PRM-041-V2-E` | $1.000,00 | unidad | 985129 / 985129 / 985120 | QA-PRM-041-V2-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-041-V2` | Familia `985120` | Llevar 3 y pagar 2 | ON | Activa; hoy -365 días a hoy +365 días | Todos |
...
| ---: | --- | --- | --- |
| 1 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 2 | Cargar 1 u de `QA-PRM-041-V2-A` por código. | `QA-PRM-041-V2-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-041-V2-B` por código. | `QA-PRM-041-V2-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-041-V2-B` × 1 u: precio $2.000,00; automático $0,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 4 | Cargar 1 u de `QA-PRM-041-V2-C` por código. | `QA-PRM-041-V2-A` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-041-V2-B` × 1 u: precio $2.000,00; automático $666,67; manual $0,00; neto $1.333,33; lista aplicada: precio normal<br>`QA-PRM-041-V2-C` × 1 u: precio $3.000,00; automático $1.000,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$4.000,00**. |
| 5 | Seleccionar `QA-PRM-041-V2-C`, abrir Ctrl+E y elegir Eliminar. | `QA-PRM-041-V2-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-041-V2-B` × 1 u: precio $2.000,00; automático $0,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 6 | Cargar 1 u de `QA-PRM-041-V2-C` por código. | `QA-PRM-041-V2-A` × 1 u: precio $1.000,00; automático $333,33; manual $0,00; neto $666,67; lista aplicada: precio normal<br>`QA-PRM-041-V2-B` × 1 u: precio $2.000,00; automático $666,67; manual $0,00; neto $1.333,33; lista aplicada: precio normal<br>`QA-PRM-041-V2-C` × 1 u: precio $3.000,00; automático $1.000,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$4.000,00**. |
...
- Datos existentes para la variante agrupada activada: `catalogo-comercial-v1`, ejemplo `AGRUPADA-3X2`; A = `QA-SEED-GRUPO-A`, B = `QA-SEED-GRUPO-B`, C = `QA-SEED-GRUPO-C`, familia exclusiva `QA-SEED-AGRUPADA`. Ajeno = `QA-SEED-NORMAL`. La copia de perfil con agrupación desactivada y la variante de precios diferentes son **NUEVO PENDIENTE DE PREPARAR**; no están incluidas en ese ejemplo.
- A y B pertenecen a la misma familia. Ajeno tiene otra familia aunque comparta marca o sector; no usar esos atributos como criterio de inclusión. C también pertenece al grupo elegido.
