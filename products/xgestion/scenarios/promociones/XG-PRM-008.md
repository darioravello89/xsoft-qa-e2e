---
{"id":"XG-PRM-008","title":"Aplicar el 10 % desde dos unidades por producto","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-alcances","ofertas-producto","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/producto.robot","seed":"catalogo-comercial-v1"}
---
...
El vendedor comprueba 10 % desde 2 unidades por producto, distingue los productos incluidos de los ajenos y conserva el importe correcto al corregir cantidades y retomar un cobro.
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-008 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-008-A` | $1.000,00 | unidad | 980001 / 980001 / 980001 | QA-SEED |
| E | `QA-PRM-008-E` | $1.000,00 | unidad | 980001 / 980001 / 980001 | QA-SEED |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-008` | Producto `QA-PRM-008-A` | Desde 2: 10 % sobre toda la cantidad | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-008-E` por código. | `QA-PRM-008-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-008-A` por código. | `QA-PRM-008-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-008-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Seleccionar `QA-PRM-008-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-008-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-008-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$2.800,00**. |
| 5 | Seleccionar `QA-PRM-008-A`, abrir Ctrl+E, dejar 3 u y guardar. | `QA-PRM-008-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-008-A` × 3 u: precio $1.000,00; automático $300,00; manual $0,00; neto $2.700,00; lista aplicada: precio normal | Total **$3.700,00**. |
| 6 | Seleccionar `QA-PRM-008-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-008-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-008-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 7 | Seleccionar `QA-PRM-008-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-008-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-008-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$2.800,00**. |
| 8 | Abrir cobro en efectivo del perfil QA, ingresar $2.800,00 y cancelar antes de confirmar. | `QA-PRM-008-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-008-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$2.800,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 9 | Retomar el cobro en efectivo del perfil QA, ingresar $2.800,00 y confirmar una sola vez. | `QA-PRM-008-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-008-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$2.800,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-008-E` −1 u; `QA-PRM-008-A` −2 u. |
...
- Datos disponibles en `catalogo-comercial-v1`: A = `QA-SEED-MIN-PCT` (artículo 980105); oferta exclusiva de ese producto; E = `QA-SEED-NORMAL` (980001), ajeno y sin ofertas. Ejemplo público `MIN-PCT-Q2` en [pricing.py](../../seeds/pricing.py).
...
| 3 | Cargar A (`QA-SEED-MIN-PCT`), cantidad 1. | A: bruto $1.000,00, descuento $0,00, neto $1.000,00. E continúa en $1.000,00; total de venta $2.000,00. |
...
| 7 | Editar A nuevamente a cantidad 2. | A queda en $1.800,00 y E en $1.000,00; total $2.800,00. Se mantienen identidades y una línea por producto. |
| 8 | Abrir el cobro y cancelarlo antes de confirmar. | La venta vuelve con el mismo total $2.800,00 y las mismas líneas. No queda venta confirmada, cobro ni movimiento de stock/caja. |
| 9 | Retomar el cobro, entregar $2.800,00 en efectivo y confirmar una sola vez. | Venta cerrada por $2.800,00, vuelto cero; no cobra otra vez el intento cancelado. |
| 10 | Consultar el comprobante interno y contrastar los efectos de la operación. | Una venta y un cobro; bruto $3.000,00, oferta $200,00, neto $2.800,00. Stock A −2, E −1; caja +$2.800,00. |
