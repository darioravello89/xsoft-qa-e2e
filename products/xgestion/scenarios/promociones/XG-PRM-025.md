---
{"id":"XG-PRM-025","title":"Aplicar el 10 % por marca","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-alcances","ofertas-marca","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/marca.robot","seed":"catalogo-comercial-v1"}
---
...
El vendedor comprueba 10 % de descuento por marca, distingue los productos incluidos de los ajenos y conserva el importe correcto al corregir cantidades y retomar un cobro.
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-025 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-025-A` | $1.000,00 | unidad | 983500 / 983500 / 980001 | QA-PRM-025-MARCA |
| B | `QA-PRM-025-B` | $1.000,00 | unidad | 983501 / 983501 / 980001 | QA-PRM-025-MARCA |
| E | `QA-PRM-025-E` | $1.000,00 | unidad | 983500 / 983500 / 980001 | QA-PRM-025-OTRA-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-025` | Marca `QA-PRM-025-MARCA` | 10 % sobre el importe | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-025-E` por código. | `QA-PRM-025-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-025-A` por código. | `QA-PRM-025-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-025-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$1.900,00**. |
| 4 | Seleccionar `QA-PRM-025-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-025-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-025-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$2.800,00**. |
| 5 | Seleccionar `QA-PRM-025-A`, abrir Ctrl+E, dejar 3 u y guardar. | `QA-PRM-025-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-025-A` × 3 u: precio $1.000,00; automático $300,00; manual $0,00; neto $2.700,00; lista aplicada: precio normal | Total **$3.700,00**. |
| 6 | Seleccionar `QA-PRM-025-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-025-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-025-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$1.900,00**. |
| 7 | Cargar 1 u de `QA-PRM-025-B` por código. | `QA-PRM-025-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-025-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal<br>`QA-PRM-025-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$2.800,00**. |
| 8 | Seleccionar `QA-PRM-025-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-025-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-025-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal<br>`QA-PRM-025-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$3.700,00**. |
| 9 | Abrir cobro en efectivo del perfil QA, ingresar $3.700,00 y cancelar antes de confirmar. | `QA-PRM-025-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-025-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal<br>`QA-PRM-025-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$3.700,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 10 | Retomar el cobro en efectivo del perfil QA, ingresar $3.700,00 y confirmar una sola vez. | `QA-PRM-025-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-025-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal<br>`QA-PRM-025-B` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$3.700,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-025-E` −1 u; `QA-PRM-025-A` −2 u; `QA-PRM-025-B` −1 u. |
...
- Datos disponibles en `catalogo-comercial-v1`: A = `QA-SEED-MARCA`, con oferta del 10 % por marca `QA-SEED-MARCA-115`; E = `QA-SEED-NORMAL`, sin ofertas.
- **Dato nuevo pendiente de preparar:** B = `QA-PEND-PRM-025-B`, otro producto del mismo alcance que A. Es un identificador propuesto; aún no existe en el seed. Preparar la ampliación del catálogo y sus controles de aislamiento antes de automatizar, sin insertar filas ad hoc sobre el seed protegido.
...
| 3 | Cargar A (`QA-SEED-MARCA`), cantidad 1. | A: bruto $1.000,00, descuento $100,00, neto $900,00. E continúa en $1.000,00; total de venta $1.900,00. |
...
| 7 | Cargar B (`QA-PEND-PRM-025-B`), cantidad 1, sin modificar A. | A y B se calculan por separado: cada uno queda en $900,00; E sigue en $1.000,00; total $2.800,00. Ambos productos incluidos reciben el beneficio y E queda excluido. |
