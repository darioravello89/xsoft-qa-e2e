---
{"id":"XG-PRM-075","title":"Aplicar una oferta a varios medios seleccionados y excluir otro","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-condiciones","cobros","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/medios-pago.robot","seed":"catalogo-comercial-v1"}
---
...
Aplicar una oferta a varios medios seleccionados y excluir otro durante una venta, con importes y efectos observables por el vendedor o cajero.
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-075 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-075-V0-A` | $1.000,00 | unidad | 980001 / 980001 / 980001 | QA-SEED |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-075-V0` | Producto `QA-PRM-075-V0-A` | 10 % sobre el importe | OFF | Activa; hoy -365 días a hoy +365 días | QA-PRM-EFECTIVO, QA-PRM-TRANSFERENCIA |
...
| 3 | Cargar 1 u de `QA-PRM-075-V0-A` por código. | `QA-PRM-075-V0-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. |
| 4 | Cargar 1 u de `QA-PRM-075-V0-A` por código. | `QA-PRM-075-V0-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 5 | Abrir cobro en `QA-PRM-EFECTIVO`, ingresar $1.800,00 y cancelar antes de confirmar. | `QA-PRM-075-V0-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 6 | Retomar el cobro en `QA-PRM-EFECTIVO`, ingresar $1.800,00 y confirmar una sola vez. | `QA-PRM-075-V0-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. Una venta y un cobro en `QA-PRM-EFECTIVO`; vuelto cero. Stock: `QA-PRM-075-V0-A` −2 u. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-075-V1-A` | $1.000,00 | unidad | 980001 / 980001 / 980001 | QA-SEED |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-075-V1` | Producto `QA-PRM-075-V1-A` | 10 % sobre el importe | OFF | Activa; hoy -365 días a hoy +365 días | QA-PRM-EFECTIVO, QA-PRM-TRANSFERENCIA |
...
| ---: | --- | --- | --- |
| 1 | Abrir una venta nueva y comprobar el contexto QA. | Sin renglones en la operación. | Total **$0,00**. ARS; precio normal y efectivo del perfil QA. |
| 2 | Elegir `QA-PRM-TRANSFERENCIA` y comprobar el recálculo. | Sin renglones en la operación. | Total **$0,00**. |
| 3 | Cargar 1 u de `QA-PRM-075-V1-A` por código. | `QA-PRM-075-V1-A` × 1 u: precio $1.000,00; automático $100,00; manual $0,00; neto $900,00; lista aplicada: precio normal | Total **$900,00**. |
| 4 | Cargar 1 u de `QA-PRM-075-V1-A` por código. | `QA-PRM-075-V1-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. |
| 5 | Abrir cobro en `QA-PRM-TRANSFERENCIA`, ingresar $1.800,00 y cancelar antes de confirmar. | `QA-PRM-075-V1-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 6 | Retomar el cobro en `QA-PRM-TRANSFERENCIA`, ingresar $1.800,00 y confirmar una sola vez. | `QA-PRM-075-V1-A` × 2 u: precio $1.000,00; automático $200,00; manual $0,00; neto $1.800,00; lista aplicada: precio normal | Total **$1.800,00**. Una venta y un cobro en `QA-PRM-TRANSFERENCIA`; vuelto cero. Stock: `QA-PRM-075-V1-A` −2 u. |
...
| Referencia | Código | Precio base | Unidad | Familia / subfamilia / sector | Marca |
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-075-V2-A` | $1.000,00 | unidad | 980001 / 980001 / 980001 | QA-SEED |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-075-V2` | Producto `QA-PRM-075-V2-A` | 10 % sobre el importe | OFF | Activa; hoy -365 días a hoy +365 días | QA-PRM-EFECTIVO, QA-PRM-TRANSFERENCIA |
...
| 3 | Cargar 1 u de `QA-PRM-075-V2-A` por código. | `QA-PRM-075-V2-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 4 | Cargar 1 u de `QA-PRM-075-V2-A` por código. | `QA-PRM-075-V2-A` × 2 u: precio $1.000,00; automático $0,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 5 | Abrir cobro en `QA-PRM-TARJETA`, ingresar $2.000,00 y cancelar antes de confirmar. | `QA-PRM-075-V2-A` × 2 u: precio $1.000,00; automático $0,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$2.000,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 6 | Retomar el cobro en `QA-PRM-TARJETA`, ingresar $2.000,00 y confirmar una sola vez. | `QA-PRM-075-V2-A` × 2 u: precio $1.000,00; automático $0,00; manual $0,00; neto $2.000,00; lista aplicada: precio normal | Total **$2.000,00**. Una venta y un cobro en `QA-PRM-TARJETA`; vuelto cero. Stock: `QA-PRM-075-V2-A` −2 u. |
...
- Producto nuevo de $1.000 con 10% para Efectivo y Transferencia, pero no Tarjeta. Son medios manuales offline sin porcentajes adicionales. La selección de varios medios en la oferta no significa dividir un cobro entre varios medios.
...
| --- | --- |
| En corridas separadas cargar dos unidades eligiendo efectivo o transferencia. | Neto $1.800 en ambos. |
| Repetir el recorrido eligiendo tarjeta manual. | Neto $2.000; la selección múltiple no equivale a Todos. |
| En cada medio abrir y cancelar el cobro, luego retomarlo. | Se mantiene el neto correspondiente y no hay pago durante la cancelación. |
| Confirmar el pago en cada corrida. | Una venta y un pago simple, con el medio y descuento esperados; nunca pago múltiple por esta configuración. |

## Dependencias para automatizar

Ampliar fixture con selección válida de medios. Validación de configuración corrupta pertenece a otro caso; no entregar JSON privado ni asumir IDs de medios universales.
...
Rutas relativas a XGestion2: `test/ModuloFinanzas/Entidades/OfertaTiposCobroTest.java`; `src/ModuloFinanzas/Entidades/OfertaTiposCobro.java`.
