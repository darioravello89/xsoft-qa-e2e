---
{"id":"XG-PRM-031","title":"Cobrar a $800 la unidad desde dos unidades por marca","product":"xgestion","module":"promociones","tags":["xgestion","regression","promociones","promociones-alcances","ofertas-marca","escritura"],"status":"implemented","test":"products/xgestion/suites/ofertas/marca.robot","seed":"catalogo-comercial-v1"}
---
...
El vendedor comprueba precio de $800 desde 2 unidades por marca, distingue los productos incluidos de los ajenos y conserva el importe correcto al corregir cantidades y retomar un cobro.
...
```powershell
.\qa.cmd run --product xgestion --scenario XG-PRM-031 --seed catalogo-comercial-v1 --log-level DEBUG
```
...
| --- | --- | ---: | --- | --- | --- |
| A | `QA-PRM-031-A` | $1.000,00 | unidad | 984100 / 984100 / 980001 | QA-PRM-031-MARCA |
| B | `QA-PRM-031-B` | $1.000,00 | unidad | 984101 / 984101 / 980001 | QA-PRM-031-MARCA |
| E | `QA-PRM-031-E` | $1.000,00 | unidad | 984100 / 984100 / 980001 | QA-PRM-031-OTRA-MARCA |

### Ofertas preparadas

| Oferta | Incluye | Regla | Agrupación | Estado / vigencia inclusiva | Medios habilitados |
| --- | --- | --- | --- | --- | --- |
| `QA-PRM-031` | Marca `QA-PRM-031-MARCA` | Desde 2: precio final $800,00 por unidad | OFF | Activa; hoy -365 días a hoy +365 días | Todos |
...
| 2 | Cargar 1 u de `QA-PRM-031-E` por código. | `QA-PRM-031-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$1.000,00**. |
| 3 | Cargar 1 u de `QA-PRM-031-A` por código. | `QA-PRM-031-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-031-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 4 | Seleccionar `QA-PRM-031-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-031-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-031-A` × 2 u: precio $1.000,00; automático $400,00; manual $0,00; neto $1.600,00; lista aplicada: precio normal | Total **$2.600,00**. |
| 5 | Seleccionar `QA-PRM-031-A`, abrir Ctrl+E, dejar 3 u y guardar. | `QA-PRM-031-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-031-A` × 3 u: precio $1.000,00; automático $600,00; manual $0,00; neto $2.400,00; lista aplicada: precio normal | Total **$3.400,00**. |
| 6 | Seleccionar `QA-PRM-031-A`, abrir Ctrl+E, dejar 1 u y guardar. | `QA-PRM-031-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-031-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$2.000,00**. |
| 7 | Cargar 1 u de `QA-PRM-031-B` por código. | `QA-PRM-031-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-031-A` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-031-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.000,00**. |
| 8 | Seleccionar `QA-PRM-031-A`, abrir Ctrl+E, dejar 2 u y guardar. | `QA-PRM-031-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-031-A` × 2 u: precio $1.000,00; automático $400,00; manual $0,00; neto $1.600,00; lista aplicada: precio normal<br>`QA-PRM-031-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.600,00**. |
| 9 | Abrir cobro en efectivo del perfil QA, ingresar $3.600,00 y cancelar antes de confirmar. | `QA-PRM-031-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-031-A` × 2 u: precio $1.000,00; automático $400,00; manual $0,00; neto $1.600,00; lista aplicada: precio normal<br>`QA-PRM-031-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.600,00**. Conserva toda la canasta; sin venta cobrada, pago ni movimientos. |
| 10 | Retomar el cobro en efectivo del perfil QA, ingresar $3.600,00 y confirmar una sola vez. | `QA-PRM-031-E` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal<br>`QA-PRM-031-A` × 2 u: precio $1.000,00; automático $400,00; manual $0,00; neto $1.600,00; lista aplicada: precio normal<br>`QA-PRM-031-B` × 1 u: precio $1.000,00; automático $0,00; manual $0,00; neto $1.000,00; lista aplicada: precio normal | Total **$3.600,00**. Una venta y un cobro en efectivo del perfil QA; vuelto cero. Stock: `QA-PRM-031-E` −1 u; `QA-PRM-031-A` −2 u; `QA-PRM-031-B` −1 u. |
...
- **Fixture nuevo pendiente de preparar:** `xg-prm-031-alcance-v1`. A = `QA-PEND-PRM-031-A` y B = `QA-PEND-PRM-031-B` son identificadores propuestos, todavía ausentes del seed; deben tener una clasificación exclusiva para esta oferta. E = `QA-SEED-NORMAL` puede reutilizarse del catálogo base y debe quedar fuera del alcance.
...
| 3 | Cargar A (`QA-PEND-PRM-031-A`), cantidad 1. | A: bruto $1.000,00, descuento $0,00, neto $1.000,00. E continúa en $1.000,00; total de venta $2.000,00. |
...
| 7 | Cargar B (`QA-PEND-PRM-031-B`), cantidad 1, sin modificar A. | A y B se calculan por separado: cada uno queda en $1.000,00; E sigue en $1.000,00; total $3.000,00. Aunque A+B suman dos unidades del alcance, ninguno alcanza por separado el mínimo; no hay beneficio agrupado. |
