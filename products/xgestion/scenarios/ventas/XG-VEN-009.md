---
{"id":"XG-VEN-009","title":"Comenzar otra venta después de abandonar","product":"xgestion","module":"ventas","tags":["xgestion","regression","ventas","escritura"],"status":"planned"}
---
...
2. Abandonar confirmando. **Esperado:** cierra el formulario sin registrar una venta.
3. Abrir otra venta sin reiniciar XGestion. **Esperado:** estado inicial del perfil, sin líneas, cantidades ni importes de la abandonada.
...
Comparar ambas cancelaciones con referencia inicial: mismos IDs de ventas, stock y caja. Evidencia UI de la segunda operación para demostrar limpieza del formulario.
...
FormVenta.java:648, abandono; :709 auditoría y :4399/:4448 nueva venta. Comparar los defaults del perfil, no blancos genéricos.
