---
{"id": "XG-KEY-007", "title": "Atajos en mesas", "product": "xgestion", "module": "atajos-listados", "priority": "P1", "tags": ["xgestion", "regression", "atajos-listados", "lectura", "p1", "filtros-listados"], "status": "implemented", "test": "products/xgestion/suites/atajos_listados.robot"}
---
...
Operar **Mesas** por teclado conservando identidad y restricciones.
...
Identidad esperada: **Nombre/número único, zona y sucursal**. No suponer accesible el ID de columna oculta.

## Pasos y resultados

| Paso | Acción | Resultado esperado |
| ---: | --- | --- |
| 1 | Abrir Mesas; desde otro control usar Ctrl+B. | Foco real en buscador y leyenda gris de atajos visible junto a él. |
...
| 4 | Enter en primera, intermedia y última fila; comprobar destino y cancelar sin guardar. | Editor de mantenimiento de la mesa seleccionada; no cuenta de Restobar. Contrastar nombre/número único, zona y sucursal. |
...
- F01–F09, usando: **Zona**. F08 sólo para fechas/cascada cuando existen.
- Preparar mesas en dos zonas; filtrar una zona, aplicar y cancelar otra. La mesa excluida no queda seleccionada ni se abre por Enter. No abrir/cerrar cuentas, comandas ni cobros.
...
- `src/ModuloRestobar/Vistas/formMesas.java`; apertura compartida de Enter/doble clic.
