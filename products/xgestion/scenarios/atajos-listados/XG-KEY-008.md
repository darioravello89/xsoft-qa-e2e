---
{"id": "XG-KEY-008", "title": "Atajos en usuarios", "product": "xgestion", "module": "atajos-listados", "priority": "P1", "tags": ["xgestion", "regression", "atajos-listados", "lectura", "p1"], "status": "implemented", "test": "products/xgestion/suites/atajos_listados.robot"}
---
...
Operar **Usuarios** por teclado conservando identidad y restricciones.
...
Identidad esperada: **Usuario de acceso y nombre visible únicos**. No suponer accesible el ID de columna oculta.

## Pasos y resultados

| Paso | Acción | Resultado esperado |
| ---: | --- | --- |
| 1 | Abrir Usuarios; desde otro control usar Ctrl+B. | Foco real en buscador y leyenda gris de atajos visible junto a él. |
...
| 4 | Enter en primera, intermedia y última fila; comprobar destino y cancelar sin guardar. | Ficha del usuario QA seleccionado. Contrastar usuario de acceso y nombre visible únicos. |
...
- Operador autorizado y restringido según permisos del paquete. Sólo leer identidad visible; jamás contraseña, token ni configuración completa. No guardar, cambiar permisos o editar al operador autenticado. Ctrl+F no abre modal.
...
- `src/ModuloConfiguracion/Vistas/FormUsuarios.java`; apertura compartida de Enter/doble clic.
