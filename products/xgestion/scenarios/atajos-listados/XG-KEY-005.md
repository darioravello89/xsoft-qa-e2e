---
{"id": "XG-KEY-005", "title": "Atajos en clientes", "product": "xgestion", "module": "atajos-listados", "priority": "P1", "tags": ["xgestion", "regression", "atajos-listados", "lectura", "p1"], "status": "implemented", "test": "products/xgestion/suites/atajos_listados.robot"}
---
...
Operar **Clientes** por teclado conservando identidad y restricciones.
...
Identidad esperada: **Nombre/apellido únicos y documento**. No suponer accesible el ID de columna oculta.

## Pasos y resultados

| Paso | Acción | Resultado esperado |
| ---: | --- | --- |
| 1 | Abrir Clientes; desde otro control usar Ctrl+B. | Foco real en buscador y leyenda gris de atajos visible junto a él. |
...
| 4 | Enter en primera, intermedia y última fila; comprobar destino y cancelar sin guardar. | Ficha del cliente seleccionado. Contrastar nombre/apellido únicos y documento. |
...
- Usar dos clientes cuyos nombres compartan una parte pero sigan siendo inequívocos. Buscar por el dato soportado, cancelar ficha y verificar continuidad. Ctrl+F no crea modal ni roba foco.
...
- `src/ModuloFinanzas/Vistas/FormClientes.java`; apertura compartida de Enter/doble clic.
