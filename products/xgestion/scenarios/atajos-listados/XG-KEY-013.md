---
{"id": "XG-KEY-013", "title": "Atajos en subcategorías", "product": "xgestion", "module": "atajos-listados", "priority": "P1", "tags": ["xgestion", "regression", "atajos-listados", "lectura", "p1", "filtros-listados"], "status": "implemented", "test": "products/xgestion/suites/atajos_listados.robot"}
---
...
Operar **Subcategorías** por teclado conservando identidad y restricciones.
...
Identidad esperada: **Nombre único y categoría padre**. No suponer accesible el ID de columna oculta.

## Pasos y resultados

| Paso | Acción | Resultado esperado |
| ---: | --- | --- |
| 1 | Abrir Subcategorías; desde otro control usar Ctrl+B. | Foco real en buscador y leyenda gris de atajos visible junto a él. |
...
| 4 | Enter en primera, intermedia y última fila; comprobar destino y cancelar sin guardar. | Editor de la subcategoría seleccionada con el padre esperado. Contrastar nombre único y categoría padre. |
...
- F01–F09, usando: **Categoría**. F08 sólo para fechas/cascada cuando existen.
- Preparar dos categorías con subcategorías inequívocas. Aplicar otro padre excluye las anteriores; cancelar/escape/X mantienen el padre aplicado. No aceptar sólo el nombre sin contrastar categoría.
...
- `src/ModuloProductos/Vistas/FormSubfamilias.java`; apertura compartida de Enter/doble clic.
