---
{"id":"XG-LPR-005","title":"Aplicar la lista del cliente antes que turno y base","product":"xgestion","module":"listas-precios","tags":["xgestion","regression","precios","listas-precios","listas-cliente","listas-prioridad"],"status":"planned"}
---

# XG-LPR-005 — Aplicar la lista del cliente antes que turno y base

## Objetivo

Cobrar al cliente identificado el precio pactado cuando también existen otras listas válidas.
...
- Fixture NUEVO PENDIENTE: A normal=$1.000; cliente C=$750, turno T=$850, fija F=$800 y sucursal S=$900; todos activos, sin descuentos adicionales; recálculo ON.
...
| ---: | --- | --- |
| 1 | Abrir venta sin elegir cliente. | T es la lista automática por encima de F y S; total $0. |
| 2 | Elegir C antes de cargar productos. | Selector C y cliente correcto. |
| 3 | Cargar A × 2. | Precio $750; total $1.500; no suma ni promedia otras listas. |
| 4 | Cancelar cobro, retomarlo y confirmar $1.500 una vez. | Conserva C; una venta/cobro; stock de A baja 2. |

## Variantes y dependencias

Repetir con fija=0 y fija=-1: C sigue primero. Comparar identidades válidas y no solamente nombres parecidos.
