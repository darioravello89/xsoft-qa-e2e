---
{"id":"XG-LPR-008","title":"Aplicar la lista del horario antes que fija o sucursal","product":"xgestion","module":"listas-precios","tags":["xgestion","regression","precios","listas-precios","listas-horario","listas-prioridad"],"status":"planned"}
---

# XG-LPR-008 — Aplicar la lista del horario antes que fija o sucursal

## Objetivo

Comenzar una venta con el precio del horario comercial vigente sin elegirlo manualmente.
...
- Fixture NUEVO PENDIENTE: T=08:00–15:00 con A=$850; F=$800; S=$900; sin lista de cliente. Laboratorio preparado a las 10:00.
...
| ---: | --- | --- |
| 1 | Abrir venta a las 10:00. | Selector T; A × 2=$1.700. |
| 2 | Cancelar cobro y abandonar. | Sin efectos de venta cobrada. |
| 3 | Abrir otra corrida fuera del horario con fija F. | Selector F; A × 2=$1.600. |
| 4 | Repetir fuera del horario con fija=-1. | Selector S; A × 2=$1.800. |

## Variantes y dependencias

El horario comercial para precios no se deduce de quién abrió la caja. No acreditar refresco automático de una ventana ya abierta al avanzar el reloj: la resolución verificada sucede al abrir o cambiar cliente.
