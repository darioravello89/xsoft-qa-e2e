---
{"id":"XG-RES-027","title":"Cancelar el cobro de la mesa y retomarlo","product":"xgestion","module":"restobar","tags":["xgestion","regression","restobar","mesas","cobros","recuperacion"],"status":"planned"}
---

# XG-RES-027 — Cancelar el cobro de la mesa y retomarlo

## Objetivo

Cancelar el cobro de la mesa y retomarlo, desde la perspectiva del mozo, cajero o supervisor que opera el pedido.
...
- Mesa abierta por $2.000; efectivo, diálogo habilitado, sin factura ni impresión.
- No extrapolar los tests de Venta cotidiana: el estado de mesa y la cuenta persistida se verifican aquí.
...
| --- | --- |
| Abrir Cerrar e ingresar recibido $3.000. | Se presenta vuelto $1.000 según perfil. |
| Cancelar el diálogo. | La mesa sigue ocupada y la cuenta abierta por $2.000; no se contabiliza un cobro. |
| Agregar bebida $500 y volver al cobro. | Total $2.500; recibido y vuelto se recalculan sin conservar importes incompatibles. |
| Confirmar recibido $3.000. | Un solo cobro de $2.500 y vuelto $500; mesa liberada tras el cierre confirmado. |

## Variantes y límites

Cancelar desde botón, Escape y menú F4; rechazo de validación previa; nunca liberar mesa por abrir el diálogo.
...
- `src/ModuloVentas/Vistas/Dialogs/formTicketCierre.java`
