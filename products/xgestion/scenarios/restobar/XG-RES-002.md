---
{"id":"XG-RES-002","title":"Abrir una mesa con cubiertos y retomar su cuenta","product":"xgestion","module":"restobar","tags":["xgestion","regression","restobar","mesas"],"status":"planned"}
---

# XG-RES-002 — Abrir una mesa con cubiertos y retomar su cuenta

## Objetivo

Abrir una mesa con cubiertos y retomar su cuenta, desde la perspectiva del mozo, cajero o supervisor que opera el pedido.
...
- Mesa QA-MESA-A libre; dos cubiertos a $100 cada uno; plato QA-PLATO a $1.000; mozo QA-MOZO-A. Preguntar cubiertos habilitado.
- Paquete de salón y mesas, pendiente.
...
| --- | --- |
| Abrir la mesa y confirmar dos cubiertos. | La mesa queda asociada a una cuenta abierta con dos comensales. |
| Agregar un plato y revisar los importes. | Consumo $1.000, cubiertos $200, total $1.200. |
| Salir al salón y volver a abrir QA-MESA-A. | Se retoma la misma cuenta, con el mismo plato y cubiertos; no se crea otra. |
| Agregar una bebida de $500 y volver a consultar. | Total $1.700; cuenta abierta y mesa ocupada, sin registrar un cobro. |

## Variantes y límites

Perfil sin pregunta: declarar el cubierto predeterminado y su precio. Repetir con una mesa en otro sector sin compartir identidades ni consumos.
...
- `src/ModuloRestobar/Vistas/formSalon.java`
