---
{"id":"XG-RES-031","title":"Gestionar delivery separando reparto y cobro","product":"xgestion","module":"restobar","tags":["xgestion","regression","restobar","delivery","cobros"],"status":"planned"}
---

# XG-RES-031 — Gestionar delivery separando reparto y cobro

## Objetivo

Gestionar delivery separando reparto y cobro, desde la perspectiva del mozo, cajero o supervisor que opera el pedido.

## Estado y alcance

**Pendiente de automatizar — `planned`. Prioridad P1; etapa 5.**
Referencia de planificación: **R16**. Ver [mapa de Restobar](../../docs/restobar.md).
...
- Cliente QA-DELIVERY con domicilio sintético, cadete QA-CADETE, pedido $1.500. Perfil de entrega y cobro declarado, sin mensajería real.
- Paquete de delivery pendiente; sin contactos ni envíos externos.
...
| --- | --- |
| Crear el pedido con cliente/dirección y asignar cadete. | Se muestra el destino y responsable correctos sin afectar pedidos de salón. |
| Marcar En proceso y luego En camino. | Cambia reparto; por sí solo no aparece un pago ni se presupone cobrado. |
| Retomar el pedido, revisar consumos y registrar el cobro según perfil. | Un pago por $1.500 vinculado al pedido correcto. |
| Consultar entregado y cobrado por separado. | Ambos estados tienen evidencia propia; volver a consultar no genera otro cobro. |

## Variantes y límites

Cancelar selección de cadete, dirección incompleta, cambio de cliente antes de salir y entrega con pago pendiente. No inventar un estado Entregado si el JAR no lo expone; calibrar la acción de entrega disponible.
...
- `src/ModuloRestobar/Vistas/formDelivery.java`
