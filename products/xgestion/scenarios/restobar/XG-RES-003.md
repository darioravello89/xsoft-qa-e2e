---
{"id":"XG-RES-003","title":"Cancelar los cubiertos y recuperar una mesa libre","product":"xgestion","module":"restobar","tags":["xgestion","regression","restobar","mesas","recuperacion"],"status":"planned"}
---

# XG-RES-003 — Cancelar los cubiertos y recuperar una mesa libre

## Objetivo

Cancelar los cubiertos y recuperar una mesa libre, desde la perspectiva del mozo, cajero o supervisor que opera el pedido.

## Estado y alcance

**Pendiente de automatizar — `planned`. Prioridad P0; etapa 5.**
Referencia de planificación: **R02**. Ver [mapa de Restobar](../../docs/restobar.md).
...
- QA-MESA-A libre, pregunta de cubiertos habilitada y ninguna cuenta previa. QA-MESA-B ocupada con un consumo de control.
- Sin cocina ni cobro.
...
| --- | --- |
| Abrir QA-MESA-A y cancelar la pregunta de cubiertos. | Se regresa sin dejar una cuenta operativa ni una mesa ocupada por la apertura cancelada. |
| Refrescar el salón. | A continúa libre; B conserva su cuenta y consumo. |
| Volver a abrir A y confirmar dos cubiertos. | Se permite comenzar una cuenta válida; no se retoma un intento cancelado. |
| Salir y reabrir después de agregar un plato. | Se conserva solo la cuenta confirmada. |

## Variantes y límites

Comparar cancelar mediante botón, Escape y cierre de ventana donde estén disponibles. Salir de una cuenta que ya tenía consumos no debe liberarla como si nunca se hubiera creado.
...
- `src/ModuloRestobar/Vistas/formCubiertos.java`
