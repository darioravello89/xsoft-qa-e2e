---
{"id":"XG-RES-022","title":"Enviar la primera comanda con platos, extras y notas","product":"xgestion","module":"restobar","tags":["xgestion","regression","restobar","mesas","preparacion","kds","impresion","restobar-opciones"],"status":"planned"}
---

# XG-RES-022 — Enviar la primera comanda con platos, extras y notas

## Objetivo

Enviar la primera comanda con platos, extras y notas, desde la perspectiva del mozo, cajero o supervisor que opera el pedido.

## Estado y alcance

**Pendiente de automatizar — `planned`. Prioridad P0; etapa 5.**
Referencia de planificación: **R08**. Ver [mapa de Restobar](../../docs/restobar.md).
...
- Mesa A con plato $1.200 con queso y nota Sin sal, bebida $500 de barra; enrutamiento cocina/barra, KDS y salidas de prueba identificadas.
- Laboratorio KDS/impresión autorizado; la VM offline actual no habilita esta integración.
...
| --- | --- |
| Revisar el pedido antes de Enviar a cocina. | Cuenta abierta por $1.700; cada consumo tiene destino declarado. |
| Enviar la primera comanda. | Cocina recibe el plato con cantidad, queso y nota; barra recibe la bebida según perfil, sin cruzar mesa. |
| Consultar el pedido y el tablero de cocina. | La cuenta sigue abierta; la recepción de cocina no equivale a un cobro. |
| Volver a consultar sin nuevos consumos. | No aparecen nuevas unidades ni se genera un pago por consultar. |

## Variantes y límites

Comanda vacía, producto no enviado a cocina, destino sin impresora y sin mozo asignado. Si falta dispositivo o receptor se informa bloqueo; un registro local no acredita impresión física.
