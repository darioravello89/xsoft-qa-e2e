...
El catálogo tiene **14 casos implementados y 0 planificados**. XG-VEN-003/007 editan la línea mediante doble clic autorizado sobre una celda identificada por JAB y ubicada en ese momento, sin coordenadas fijas. El [backlog de accesibilidad CSV](docs/backlog-accesibilidad.csv) conserva la mejora pendiente de un atajo para abrir el editor; no agrega escenarios ni modifica el ERP.
