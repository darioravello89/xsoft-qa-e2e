...
PRICING_CASES = [
    ...
    _case("AGRUPADA-3X2", {"QA-SEED-GRUPO-A": "1", "QA-SEED-GRUPO-B": "1", "QA-SEED-GRUPO-C": "1"},
          "2000.00", _FIN_TEST + "OfertaAplicacionCalculadorAgrupacionTest.java", e2e_scenario="XG-PRM-041"),
    ...
    *[_case(name, {f"QA-SEED-{name}": "1"}, "900.00",
            "src/ModuloFinanzas/Entidades/OfertaAplicacionCalculador.java", e2e_scenario=f"XG-PRM-{number:03}")
      for name, number in (("FAMILIA", 11), ("SUBFAMILIA", 18), ("MARCA", 25), ("SECTOR", 32))],
    _case("LISTA-ARS", {"QA-SEED-LISTAS": "1"}, "750.00",
          "src/ModuloProveedores/Entidades/ListaPrecioDetalle.java", selected_list=980101,
          e2e_scenario="XG-LPR-019"),
