...
La foto actual distingue **21 fichas: 21 implementadas y 0 planificadas** —cinco de smoke, nueve de ventas y siete de promociones—, con **0 validaciones reales registradas en este mapa público**. Ese cero no afirma que nadie haya ejecutado pruebas en privado: el generador no lee reportes de QA. Los 20 recorridos R01–R20 de Restobar y los 26 ejemplos de cálculo del seed tienen su propio espacio; no se suman a las 21 fichas ni a los 21 casos implementados. Siete ejemplos seed están referidos por XG-PRM-001 a XG-PRM-007; esa relación no convierte los demás ejemplos en casos automatizados ni otorga PASS a ninguno. La mejora de accesibilidad del editor se registra en un backlog independiente; la especificación inicial del mapa conserva sus conteos históricos y las fuentes actuales determinan cada regeneración.

El grupo `promociones` cubre un primer lote: porcentaje, importe fijo, 2x1, segunda unidad al 50 % y ofertas vencidas, futuras o inactivas. Las fichas incluyen editar cantidad, cancelar/retomar y un único cobro, bajo el [perfil de promociones](../products/xgestion/docs/promociones.md). Listas, combos, otras cantidades/alcances y descuentos combinados siguen pendientes; una familia parcialmente implementada no acredita todas sus variantes.
